...
umain(int argc, char **argv)
{
  ...
  800049:	e8 93 00 00 00       	call   8000e1 <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 0d 01 00 00       	call   800170 <sys_getenvid>
	for (i = 0; i < NENV; ++i) {
...
exit(void)
{
  ...
  8000cb:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ce:	e8 63 05 00 00       	call   800636 <close_all>
	sys_env_destroy(0);
  8000d3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000da:	e8 3f 00 00 00       	call   80011e <sys_env_destroy>
}
  8000df:	c9                   	leave  
  8000e0:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80013e:	7e 28                	jle    800168 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800140:	89 44 24 10          	mov    %eax,0x10(%esp)
  800144:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80014b:	00 
  80014c:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  800153:	00 
  800154:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80015b:	00 
  80015c:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  800163:	e8 5e 10 00 00       	call   8011c6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001d0:	7e 28                	jle    8001fa <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001d2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001d6:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001dd:	00 
  8001de:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  8001e5:	00 
  8001e6:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001ed:	00 
  8001ee:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  8001f5:	e8 cc 0f 00 00       	call   8011c6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800208:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  80020b:	b8 05 00 00 00       	mov    $0x5,%eax
  800210:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800213:	8b 55 08             	mov    0x8(%ebp),%edx
  800216:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800219:	8b 7d 14             	mov    0x14(%ebp),%edi
  80021c:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  800223:	7e 28                	jle    80024d <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800225:	89 44 24 10          	mov    %eax,0x10(%esp)
  800229:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800230:	00 
  800231:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  800238:	00 
  800239:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800240:	00 
  800241:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  800248:	e8 79 0f 00 00       	call   8011c6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800263:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  800276:	7e 28                	jle    8002a0 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800278:	89 44 24 10          	mov    %eax,0x10(%esp)
  80027c:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800283:	00 
  800284:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  80028b:	00 
  80028c:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800293:	00 
  800294:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  80029b:	e8 26 0f 00 00       	call   8011c6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002c9:	7e 28                	jle    8002f3 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002cb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002cf:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  8002d6:	00 
  8002d7:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  8002de:	00 
  8002df:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002e6:	00 
  8002e7:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  8002ee:	e8 d3 0e 00 00       	call   8011c6 <_panic>
...
008002fb <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80031c:	7e 28                	jle    800346 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80031e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800322:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800329:	00 
  80032a:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  800331:	00 
  800332:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800339:	00 
  80033a:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  800341:	e8 80 0e 00 00       	call   8011c6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80035c:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80036f:	7e 28                	jle    800399 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800371:	89 44 24 10          	mov    %eax,0x10(%esp)
  800375:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80037c:	00 
  80037d:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  800384:	00 
  800385:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80038c:	00 
  80038d:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  800394:	e8 2d 0e 00 00       	call   8011c6 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003a6:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  8003a7:	be 00 00 00 00       	mov    $0x0,%esi
  8003ac:	b8 0c 00 00 00       	mov    $0xc,%eax
  8003b1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003b4:	8b 55 08             	mov    0x8(%ebp),%edx
  8003b7:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003ba:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8003da:	89 cb                	mov    %ecx,%ebx
  8003dc:	89 cf                	mov    %ecx,%edi
  8003de:	89 ce                	mov    %ecx,%esi
  ...
  8003e4:	7e 28                	jle    80040e <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003e6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003ea:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003f1:	00 
  8003f2:	c7 44 24 08 f8 20 80 	movl   $0x8020f8,0x8(%esp)
  8003f9:	00 
  8003fa:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800401:	00 
  800402:	c7 04 24 15 21 80 00 	movl   $0x802115,(%esp)
  800409:	e8 b8 0d 00 00       	call   8011c6 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80051e:	39 05 08 30 80 00    	cmp    %eax,0x803008
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800528:	b8 24 30 80 00       	mov    $0x803024,%eax
  80052d:	eb 0c                	jmp    80053b <dev_lookup+0x2a>
  80052f:	b8 40 30 80 00       	mov    $0x803040,%eax
  800534:	eb 05                	jmp    80053b <dev_lookup+0x2a>
  800536:	b8 08 30 80 00       	mov    $0x803008,%eax
		if (devtab[i]->dev_id == dev_id) {
			*dev = devtab[i];
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
		if (devtab[i]->dev_id == dev_id) {
  800544:	39 05 24 30 80 00    	cmp    %eax,0x803024
  80054a:	74 dc                	je     800528 <dev_lookup+0x17>
  80054c:	39 05 40 30 80 00    	cmp    %eax,0x803040
  ...
  800565:	c7 04 24 24 21 80 00 	movl   $0x802124,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8005f5:	e8 5b fc ff ff       	call   800255 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006f3:	e8 0a fb ff ff       	call   800202 <sys_page_map>
  ...
  80072e:	e8 cf fa ff ff       	call   800202 <sys_page_map>
...
err:
  ...
  800747:	e8 09 fb ff ff       	call   800255 <sys_page_unmap>
	sys_page_unmap(0, nva);
  80074c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800750:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800757:	e8 f9 fa ff ff       	call   800255 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007bb:	c7 04 24 65 21 80 00 	movl   $0x802165,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008a3:	c7 04 24 81 21 80 00 	movl   $0x802181,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80095c:	c7 04 24 44 21 80 00 	movl   $0x802144,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a6b:	e8 5c 13 00 00       	call   801dcc <ipc_find_env>
  ...
  800a91:	e8 d0 12 00 00       	call   801d66 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b67:	c7 44 24 0c 9e 21 80 	movl   $0x80219e,0xc(%esp)
  800b6e:	00 
  800b6f:	c7 44 24 08 a5 21 80 	movl   $0x8021a5,0x8(%esp)
  800b76:	00 
  800b77:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800b7e:	00 
  800b7f:	c7 04 24 ba 21 80 00 	movl   $0x8021ba,(%esp)
  800b86:	e8 3b 06 00 00       	call   8011c6 <_panic>
	assert(r <= PGSIZE);
  800b8b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b90:	7e 24                	jle    800bb6 <devfile_read+0x84>
  800b92:	c7 44 24 0c c5 21 80 	movl   $0x8021c5,0xc(%esp)
  800b99:	00 
  800b9a:	c7 44 24 08 a5 21 80 	movl   $0x8021a5,0x8(%esp)
  800ba1:	00 
  800ba2:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800ba9:	00 
  800baa:	c7 04 24 ba 21 80 00 	movl   $0x8021ba,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c78:	c7 44 24 04 d1 21 80 	movl   $0x8021d1,0x4(%esp)
  800c7f:	00 
  ...
  800c9a:	00 00 00 
	stat->st_dev = &devpipe;
  800c9d:	c7 83 88 00 00 00 24 	movl   $0x803024,0x88(%ebx)
  800ca4:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800cc8:	e8 88 f5 ff ff       	call   800255 <sys_page_unmap>
  ...
  800ce0:	e8 70 f5 ff ff       	call   800255 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d3e:	c7 04 24 d8 21 80 00 	movl   $0x8021d8,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d82:	75 54                	jne    800dd8 <devpipe_write+0x84>
			...
			sys_yield();
  800d84:	e8 06 f4 ff ff       	call   80018f <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e17:	75 43                	jne    800e5c <devpipe_read+0x77>
			...
			sys_yield();
  800e19:	e8 71 f3 ff ff       	call   80018f <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e9c:	e8 0d f3 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800ed6:	e8 d3 f2 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800f05:	e8 a4 f2 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800f3e:	e8 bf f2 ff ff       	call   800202 <sys_page_map>
  ...
  800f49:	8b 15 24 30 80 00    	mov    0x803024,%edx
  ...
  800f5e:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801020:	c7 44 24 04 f0 21 80 	movl   $0x8021f0,0x4(%esp)
  801027:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801086:	e8 56 f0 ff ff       	call   8000e1 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010b9:	eb 28                	jmp    8010e3 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010bb:	e8 cf f0 ff ff       	call   80018f <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010c0:	e8 3a f0 ff ff       	call   8000ff <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8010ff:	e8 dd ef ff ff       	call   8000e1 <sys_cputs>
}
  801104:	c9                   	leave  
  801105:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  80115b:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
opencons(void)
{
  ...
  801198:	e8 11 f0 ff ff       	call   8001ae <sys_page_alloc>
		return r;
  ...
  8011a3:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011d1:	8b 35 04 30 80 00    	mov    0x803004,%esi
  8011d7:	e8 94 ef ff ff       	call   800170 <sys_getenvid>
  ...
  8011f2:	c7 04 24 fc 21 80 00 	movl   $0x8021fc,(%esp)
  ...
  801208:	e8 51 00 00 00       	call   80125e <vcprintf>
	cprintf("\n");
  80120d:	c7 04 24 e9 21 80 00 	movl   $0x8021e9,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801249:	e8 93 ee ff ff       	call   8000e1 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012b2:	e8 2a ee ff ff       	call   8000e1 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8013be:	0f be 80 1f 22 80 00 	movsbl 0x80221f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80159e:	c7 44 24 08 37 22 80 	movl   $0x802237,0x8(%esp)
  8015a5:	00 
  ...
  8015be:	c7 44 24 08 b7 21 80 	movl   $0x8021b7,0x8(%esp)
  8015c5:	00 
  ...
  8015ed:	ba 30 22 80 00       	mov    $0x802230,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d0d:	83 f8 01             	cmp    $0x1,%eax
  801d10:	19 c0                	sbb    %eax,%eax
  801d12:	f7 d0                	not    %eax
  801d14:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801d19:	89 04 24             	mov    %eax,(%esp)
  801d1c:	e8 a3 e6 ff ff       	call   8003c4 <sys_ipc_recv>
	if (err_code < 0) {
  801d21:	85 c0                	test   %eax,%eax
  801d23:	79 16                	jns    801d3b <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801d25:	85 f6                	test   %esi,%esi
  801d27:	74 06                	je     801d2f <ipc_recv+0x33>
  801d29:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801d2f:	85 db                	test   %ebx,%ebx
  801d31:	74 2c                	je     801d5f <ipc_recv+0x63>
  801d33:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d39:	eb 24                	jmp    801d5f <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801d3b:	85 f6                	test   %esi,%esi
  801d3d:	74 0a                	je     801d49 <ipc_recv+0x4d>
  801d3f:	a1 04 40 80 00       	mov    0x804004,%eax
  801d44:	8b 40 74             	mov    0x74(%eax),%eax
  801d47:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801d49:	85 db                	test   %ebx,%ebx
  801d4b:	74 0a                	je     801d57 <ipc_recv+0x5b>
  801d4d:	a1 04 40 80 00       	mov    0x804004,%eax
  801d52:	8b 40 78             	mov    0x78(%eax),%eax
  801d55:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  801d57:	a1 04 40 80 00       	mov    0x804004,%eax
  801d5c:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d78:	eb 25                	jmp    801d9f <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801d7a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d7d:	74 20                	je     801d9f <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801d7f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801d83:	c7 44 24 08 20 25 80 	movl   $0x802520,0x8(%esp)
  801d8a:	00 
  801d8b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801d92:	00 
  801d93:	c7 04 24 2c 25 80 00 	movl   $0x80252c,(%esp)
  801d9a:	e8 27 f4 ff ff       	call   8011c6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801da1:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801da6:	0f 45 c3             	cmovne %ebx,%eax
  801da9:	8b 55 14             	mov    0x14(%ebp),%edx
  801dac:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801db0:	89 44 24 08          	mov    %eax,0x8(%esp)
  801db4:	89 74 24 04          	mov    %esi,0x4(%esp)
  801db8:	89 3c 24             	mov    %edi,(%esp)
  801dbb:	e8 e1 e5 ff ff       	call   8003a1 <sys_ipc_try_send>
  801dc0:	85 c0                	test   %eax,%eax
  801dc2:	75 b6                	jne    801d7a <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801dd2:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801dd7:	39 c8                	cmp    %ecx,%eax
  801dd9:	74 17                	je     801df2 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801ddb:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801de0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801de3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801de9:	8b 52 50             	mov    0x50(%edx),%edx
  801dec:	39 ca                	cmp    %ecx,%edx
  801dee:	75 14                	jne    801e04 <ipc_find_env+0x38>
  801df0:	eb 05                	jmp    801df7 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801df7:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801dfa:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801dff:	8b 40 40             	mov    0x40(%eax),%eax
  801e02:	eb 0e                	jmp    801e12 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e0c:	75 d2                	jne    801de0 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801e0e:	66 b8 00 00          	mov    $0x0,%ax
}
  801e12:	5d                   	pop    %ebp
  801e13:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e1f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e2b:	f6 c1 01             	test   $0x1,%cl
  801e2e:	74 1d                	je     801e4d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  801e3d:	74 0e                	je     801e4d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e3f:	c1 ea 0c             	shr    $0xc,%edx
  801e42:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e49:	ef 
  801e4a:	0f b7 c0             	movzwl %ax,%eax
}
  801e4d:	5d                   	pop    %ebp
  801e4e:	c3                   	ret    
  801e4f:	90                   	nop
