...
sys_env_destroy(envid_t envid)
{
  ...
  80014b:	00 
  80014c:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  800153:	00 
  800154:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80015b:	00 
  80015c:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  800163:	e8 8e 10 00 00       	call   8011f6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001dd:	00 
  8001de:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  8001e5:	00 
  8001e6:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001ed:	00 
  8001ee:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  8001f5:	e8 fc 0f 00 00       	call   8011f6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800230:	00 
  800231:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  800238:	00 
  800239:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800240:	00 
  800241:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  800248:	e8 a9 0f 00 00       	call   8011f6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800283:	00 
  800284:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  80028b:	00 
  80028c:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800293:	00 
  800294:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  80029b:	e8 56 0f 00 00       	call   8011f6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002d6:	00 
  8002d7:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  8002de:	00 
  8002df:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002e6:	00 
  8002e7:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  8002ee:	e8 03 0f 00 00       	call   8011f6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800329:	00 
  80032a:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  800331:	00 
  800332:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800339:	00 
  80033a:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  800341:	e8 b0 0e 00 00       	call   8011f6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80037c:	00 
  80037d:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  800384:	00 
  800385:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80038c:	00 
  80038d:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  800394:	e8 5d 0e 00 00       	call   8011f6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003f1:	00 
  8003f2:	c7 44 24 08 38 21 80 	movl   $0x802138,0x8(%esp)
  8003f9:	00 
  8003fa:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800401:	00 
  800402:	c7 04 24 55 21 80 00 	movl   $0x802155,(%esp)
  800409:	e8 e8 0d 00 00       	call   8011f6 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800565:	c7 04 24 64 21 80 00 	movl   $0x802164,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007bb:	c7 04 24 a5 21 80 00 	movl   $0x8021a5,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008a3:	c7 04 24 c1 21 80 00 	movl   $0x8021c1,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80095c:	c7 04 24 84 21 80 00 	movl   $0x802184,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a8f:	c7 04 24 de 21 80 00 	movl   $0x8021de,(%esp)
  ...
  800ab7:	e8 d8 12 00 00       	call   801d94 <ipc_send>
	cprintf("ipc_send\n");
  800abc:	c7 04 24 f4 21 80 00 	movl   $0x8021f4,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b99:	c7 44 24 0c fe 21 80 	movl   $0x8021fe,0xc(%esp)
  800ba0:	00 
  800ba1:	c7 44 24 08 05 22 80 	movl   $0x802205,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 1a 22 80 00 	movl   $0x80221a,(%esp)
  800bb8:	e8 39 06 00 00       	call   8011f6 <_panic>
	assert(r <= PGSIZE);
  800bbd:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800bc2:	7e 24                	jle    800be8 <devfile_read+0x84>
  800bc4:	c7 44 24 0c 25 22 80 	movl   $0x802225,0xc(%esp)
  800bcb:	00 
  800bcc:	c7 44 24 08 05 22 80 	movl   $0x802205,0x8(%esp)
  800bd3:	00 
  800bd4:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800bdb:	00 
  800bdc:	c7 04 24 1a 22 80 00 	movl   $0x80221a,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ca8:	c7 44 24 04 31 22 80 	movl   $0x802231,0x4(%esp)
  800caf:	00 
  ...
  800cca:	00 00 00 
	stat->st_dev = &devpipe;
  800ccd:	c7 83 88 00 00 00 24 	movl   $0x803024,0x88(%ebx)
  800cd4:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800cf8:	e8 58 f5 ff ff       	call   800255 <sys_page_unmap>
  ...
  800d10:	e8 40 f5 ff ff       	call   800255 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d6e:	c7 04 24 38 22 80 00 	movl   $0x802238,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800db2:	75 54                	jne    800e08 <devpipe_write+0x84>
			...
			sys_yield();
  800db4:	e8 d6 f3 ff ff       	call   80018f <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e47:	75 43                	jne    800e8c <devpipe_read+0x77>
			...
			sys_yield();
  800e49:	e8 41 f3 ff ff       	call   80018f <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800ecc:	e8 dd f2 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800f06:	e8 a3 f2 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800f35:	e8 74 f2 ff ff       	call   8001ae <sys_page_alloc>
  ...
  800f6e:	e8 8f f2 ff ff       	call   800202 <sys_page_map>
  ...
  800f79:	8b 15 24 30 80 00    	mov    0x803024,%edx
  ...
  800f8e:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801050:	c7 44 24 04 50 22 80 	movl   $0x802250,0x4(%esp)
  801057:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8010b6:	e8 26 f0 ff ff       	call   8000e1 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010e9:	eb 28                	jmp    801113 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010eb:	e8 9f f0 ff ff       	call   80018f <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010f0:	e8 0a f0 ff ff       	call   8000ff <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80112f:	e8 ad ef ff ff       	call   8000e1 <sys_cputs>
}
  801134:	c9                   	leave  
  801135:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  80118b:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
opencons(void)
{
  ...
  8011c8:	e8 e1 ef ff ff       	call   8001ae <sys_page_alloc>
		return r;
  ...
  8011d3:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801201:	8b 35 04 30 80 00    	mov    0x803004,%esi
  801207:	e8 64 ef ff ff       	call   800170 <sys_getenvid>
  ...
  801222:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
  ...
  801238:	e8 51 00 00 00       	call   80128e <vcprintf>
	cprintf("\n");
  80123d:	c7 04 24 49 22 80 00 	movl   $0x802249,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801279:	e8 63 ee ff ff       	call   8000e1 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012e2:	e8 fa ed ff ff       	call   8000e1 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8013ee:	0f be 80 7f 22 80 00 	movsbl 0x80227f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8015ce:	c7 44 24 08 97 22 80 	movl   $0x802297,0x8(%esp)
  8015d5:	00 
  ...
  8015ee:	c7 44 24 08 17 22 80 	movl   $0x802217,0x8(%esp)
  8015f5:	00 
  ...
  80161d:	ba 90 22 80 00       	mov    $0x802290,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d4a:	e8 75 e6 ff ff       	call   8003c4 <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801de9:	e8 b3 e5 ff ff       	call   8003a1 <sys_ipc_try_send>
