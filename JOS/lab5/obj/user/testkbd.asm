...
umain(int argc, char **argv)
{
  ...
  800062:	c7 44 24 08 00 24 80 	movl   $0x802400,0x8(%esp)
  800069:	00 
  80006a:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  800071:	00 
  800072:	c7 04 24 0d 24 80 00 	movl   $0x80240d,(%esp)
  ...
  800086:	c7 44 24 08 1c 24 80 	movl   $0x80241c,0x8(%esp)
  80008d:	00 
  80008e:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800095:	00 
  800096:	c7 04 24 0d 24 80 00 	movl   $0x80240d,(%esp)
  ...
  8000be:	c7 44 24 08 36 24 80 	movl   $0x802436,0x8(%esp)
  8000c5:	00 
  8000c6:	c7 44 24 04 13 00 00 	movl   $0x13,0x4(%esp)
  8000cd:	00 
  8000ce:	c7 04 24 0d 24 80 00 	movl   $0x80240d,(%esp)
  ...
  8000da:	c7 04 24 3e 24 80 00 	movl   $0x80243e,(%esp)
  ...
  8000ee:	c7 44 24 04 4c 24 80 	movl   $0x80244c,0x4(%esp)
  8000f5:	00 
  ...
  800104:	c7 44 24 04 50 24 80 	movl   $0x802450,0x4(%esp)
  80010b:	00 
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800130:	c7 44 24 04 68 24 80 	movl   $0x802468,0x4(%esp)
  800137:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800393:	c7 04 24 80 24 80 00 	movl   $0x802480,(%esp)
  ...
  8003a9:	e8 51 00 00 00       	call   8003ff <vcprintf>
	cprintf("\n");
  8003ae:	c7 04 24 66 24 80 00 	movl   $0x802466,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004fc:	e8 5f 1c 00 00       	call   802160 <__udivdi3>
  ...
  800555:	e8 36 1d 00 00       	call   802290 <__umoddi3>
  80055a:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80055e:	0f be 80 a3 24 80 00 	movsbl 0x8024a3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80067c:	ff 24 85 e0 25 80 00 	jmp    *0x8025e0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80075e:	c7 44 24 08 72 28 80 	movl   $0x802872,0x8(%esp)
  800765:	00 
  ...
  80078d:	ba b4 24 80 00       	mov    $0x8024b4,%edx
...
readline(const char *prompt)
{
  ...
  800a74:	c7 44 24 04 72 28 80 	movl   $0x802872,0x4(%esp)
  800a7b:	00 
  ...
  800ab8:	c7 04 24 9f 27 80 00 	movl   $0x80279f,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800ff6:	00 
  800ff7:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  800ffe:	00 
  800fff:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801006:	00 
  801007:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  801088:	00 
  801089:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  801090:	00 
  801091:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801098:	00 
  801099:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8010db:	00 
  8010dc:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  8010e3:	00 
  8010e4:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8010eb:	00 
  8010ec:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80112e:	00 
  80112f:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  801136:	00 
  801137:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80113e:	00 
  80113f:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  801181:	00 
  801182:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  801189:	00 
  80118a:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801191:	00 
  801192:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8011d4:	00 
  8011d5:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  8011dc:	00 
  8011dd:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8011e4:	00 
  8011e5:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801227:	00 
  801228:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  80122f:	00 
  801230:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801237:	00 
  801238:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80129c:	00 
  80129d:	c7 44 24 08 af 27 80 	movl   $0x8027af,0x8(%esp)
  8012a4:	00 
  8012a5:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8012ac:	00 
  8012ad:	c7 04 24 cc 27 80 00 	movl   $0x8027cc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801415:	c7 04 24 dc 27 80 00 	movl   $0x8027dc,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80166b:	c7 04 24 20 28 80 00 	movl   $0x802820,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801753:	c7 04 24 3c 28 80 00 	movl   $0x80283c,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80180c:	c7 04 24 fc 27 80 00 	movl   $0x8027fc,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  80191b:	e8 af 07 00 00       	call   8020cf <ipc_find_env>
  ...
  801941:	e8 23 07 00 00       	call   802069 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801a17:	c7 44 24 0c 59 28 80 	movl   $0x802859,0xc(%esp)
  801a1e:	00 
  801a1f:	c7 44 24 08 60 28 80 	movl   $0x802860,0x8(%esp)
  801a26:	00 
  801a27:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801a2e:	00 
  801a2f:	c7 04 24 75 28 80 00 	movl   $0x802875,(%esp)
  801a36:	e8 2c e9 ff ff       	call   800367 <_panic>
	assert(r <= PGSIZE);
  801a3b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801a40:	7e 24                	jle    801a66 <devfile_read+0x84>
  801a42:	c7 44 24 0c 80 28 80 	movl   $0x802880,0xc(%esp)
  801a49:	00 
  801a4a:	c7 44 24 08 60 28 80 	movl   $0x802860,0x8(%esp)
  801a51:	00 
  801a52:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801a59:	00 
  801a5a:	c7 04 24 75 28 80 00 	movl   $0x802875,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c68:	c7 44 24 04 8c 28 80 	movl   $0x80288c,0x4(%esp)
  801c6f:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d2e:	c7 04 24 93 28 80 00 	movl   $0x802893,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802010:	83 f8 01             	cmp    $0x1,%eax
  802013:	19 c0                	sbb    %eax,%eax
  802015:	f7 d0                	not    %eax
  802017:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  80201c:	89 04 24             	mov    %eax,(%esp)
  80201f:	e8 4b f2 ff ff       	call   80126f <sys_ipc_recv>
	if (err_code < 0) {
  802024:	85 c0                	test   %eax,%eax
  802026:	79 16                	jns    80203e <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  802028:	85 f6                	test   %esi,%esi
  80202a:	74 06                	je     802032 <ipc_recv+0x33>
  80202c:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  802032:	85 db                	test   %ebx,%ebx
  802034:	74 2c                	je     802062 <ipc_recv+0x63>
  802036:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  80203c:	eb 24                	jmp    802062 <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  80203e:	85 f6                	test   %esi,%esi
  802040:	74 0a                	je     80204c <ipc_recv+0x4d>
  802042:	a1 04 44 80 00       	mov    0x804404,%eax
  802047:	8b 40 74             	mov    0x74(%eax),%eax
  80204a:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  80204c:	85 db                	test   %ebx,%ebx
  80204e:	74 0a                	je     80205a <ipc_recv+0x5b>
  802050:	a1 04 44 80 00       	mov    0x804404,%eax
  802055:	8b 40 78             	mov    0x78(%eax),%eax
  802058:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  80205a:	a1 04 44 80 00       	mov    0x804404,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802072:	8b 7d 08             	mov    0x8(%ebp),%edi
  802075:	8b 75 0c             	mov    0xc(%ebp),%esi
  802078:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int err_code;
	while ((err_code = sys_ipc_try_send(to_env, val, pg == NULL ? (void*)UTOP : pg, perm))) {
  80207b:	eb 25                	jmp    8020a2 <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  80207d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  802080:	74 20                	je     8020a2 <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  802082:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802086:	c7 44 24 08 ab 28 80 	movl   $0x8028ab,0x8(%esp)
  80208d:	00 
  80208e:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  802095:	00 
  802096:	c7 04 24 b7 28 80 00 	movl   $0x8028b7,(%esp)
  80209d:	e8 c5 e2 ff ff       	call   800367 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020a9:	0f 45 c3             	cmovne %ebx,%eax
  8020ac:	8b 55 14             	mov    0x14(%ebp),%edx
  8020af:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8020b3:	89 44 24 08          	mov    %eax,0x8(%esp)
  8020b7:	89 74 24 04          	mov    %esi,0x4(%esp)
  8020bb:	89 3c 24             	mov    %edi,(%esp)
  8020be:	e8 89 f1 ff ff       	call   80124c <sys_ipc_try_send>
  8020c3:	85 c0                	test   %eax,%eax
  8020c5:	75 b6                	jne    80207d <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  8020d5:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  8020da:	39 c8                	cmp    %ecx,%eax
  8020dc:	74 17                	je     8020f5 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8020de:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  8020e3:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8020e6:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8020ec:	8b 52 50             	mov    0x50(%edx),%edx
  8020ef:	39 ca                	cmp    %ecx,%edx
  8020f1:	75 14                	jne    802107 <ipc_find_env+0x38>
  8020f3:	eb 05                	jmp    8020fa <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802105:	eb 0e                	jmp    802115 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80210f:	75 d2                	jne    8020e3 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
