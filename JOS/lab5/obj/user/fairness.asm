...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800fe6:	c7 44 24 08 ca 24 80 	movl   $0x8024ca,0x8(%esp)
  800fed:	00 
  800fee:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  800ff5:	00 
  800ff6:	c7 04 24 d6 24 80 00 	movl   $0x8024d6,(%esp)
  800ffd:	e8 24 0e 00 00       	call   801e26 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
...
fsipc(unsigned type, void *dstva)
{
  ...
  8016f1:	e8 d3 f8 ff ff       	call   800fc9 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8017d6:	00 
  8017d7:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  8017de:	00 
  ...
  801801:	00 
  801802:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801809:	00 
