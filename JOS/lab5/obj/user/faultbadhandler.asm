...
fsipc(unsigned type, void *dstva)
{
  ...
  800a8b:	e8 5a 13 00 00       	call   801dea <ipc_find_env>
  ...
  800ab1:	e8 ce 12 00 00       	call   801d84 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b96:	00 
  800b97:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  800b9e:	00 
  ...
  800bc1:	00 
  800bc2:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800bc9:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d3a:	e8 aa e6 ff ff       	call   8003e9 <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801da1:	c7 44 24 08 40 25 80 	movl   $0x802540,0x8(%esp)
  801da8:	00 
  801da9:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801db0:	00 
  801db1:	c7 04 24 4c 25 80 00 	movl   $0x80254c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dd9:	e8 e8 e5 ff ff       	call   8003c6 <sys_ipc_try_send>
