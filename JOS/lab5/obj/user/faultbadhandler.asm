...
sys_env_destroy(envid_t envid)
{
  ...
  800170:	00 
  800171:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  800178:	00 
  800179:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800180:	00 
  800181:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  800188:	e8 89 10 00 00       	call   801216 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800202:	00 
  800203:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  80020a:	00 
  80020b:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800212:	00 
  800213:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  80021a:	e8 f7 0f 00 00       	call   801216 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800255:	00 
  800256:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  80025d:	00 
  80025e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800265:	00 
  800266:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  80026d:	e8 a4 0f 00 00       	call   801216 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002a8:	00 
  8002a9:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  8002b0:	00 
  8002b1:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002b8:	00 
  8002b9:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  8002c0:	e8 51 0f 00 00       	call   801216 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002fb:	00 
  8002fc:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  800303:	00 
  800304:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80030b:	00 
  80030c:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  800313:	e8 fe 0e 00 00       	call   801216 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80034e:	00 
  80034f:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  800356:	00 
  800357:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80035e:	00 
  80035f:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  800366:	e8 ab 0e 00 00       	call   801216 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003a1:	00 
  8003a2:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  8003a9:	00 
  8003aa:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003b1:	00 
  8003b2:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  8003b9:	e8 58 0e 00 00       	call   801216 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800416:	00 
  800417:	c7 44 24 08 4a 21 80 	movl   $0x80214a,0x8(%esp)
  80041e:	00 
  80041f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800426:	00 
  800427:	c7 04 24 67 21 80 00 	movl   $0x802167,(%esp)
  80042e:	e8 e3 0d 00 00       	call   801216 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800585:	c7 04 24 78 21 80 00 	movl   $0x802178,(%esp)
  80058c:	e8 7e 0d 00 00       	call   80130f <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007db:	c7 04 24 b9 21 80 00 	movl   $0x8021b9,(%esp)
  8007e2:	e8 28 0b 00 00       	call   80130f <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008c3:	c7 04 24 d5 21 80 00 	movl   $0x8021d5,(%esp)
  8008ca:	e8 40 0a 00 00       	call   80130f <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80097c:	c7 04 24 98 21 80 00 	movl   $0x802198,(%esp)
  800983:	e8 87 09 00 00       	call   80130f <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
stat(const char *path, struct Stat *stat)
{
  ...
  800a42:	e8 e1 01 00 00       	call   800c28 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a8b:	e8 8a 13 00 00       	call   801e1a <ipc_find_env>
  ...
  800a9a:	8b 40 48             	mov    0x48(%eax),%eax
  800a9d:	8b 15 00 50 80 00    	mov    0x805000,%edx
  800aa3:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800aa7:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800aab:	89 44 24 04          	mov    %eax,0x4(%esp)
  800aaf:	c7 04 24 f2 21 80 00 	movl   $0x8021f2,(%esp)
  800ab6:	e8 54 08 00 00       	call   80130f <cprintf>

	ipc_send(fsenv, type, &fsipcbuf, PTE_P | PTE_W | PTE_U);
  800abb:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800ac2:	00 
  800ac3:	c7 44 24 08 00 50 80 	movl   $0x805000,0x8(%esp)
  800aca:	00 
  800acb:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800acf:	a1 00 40 80 00       	mov    0x804000,%eax
  800ad4:	89 04 24             	mov    %eax,(%esp)
  800ad7:	e8 d8 12 00 00       	call   801db4 <ipc_send>
	cprintf("ipc_send\n");
  800adc:	c7 04 24 08 22 80 00 	movl   $0x802208,(%esp)
  800ae3:	e8 27 08 00 00       	call   80130f <cprintf>
	return ipc_recv(NULL, dstva, NULL);
  800ae8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  800aef:	00 
  800af0:	89 74 24 04          	mov    %esi,0x4(%esp)
  800af4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800afb:	e8 4c 12 00 00       	call   801d4c <ipc_recv>
}
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  800b21:	b8 05 00 00 00       	mov    $0x5,%eax
  800b26:	e8 44 ff ff ff       	call   800a6f <fsipc>
  800b2b:	89 c2                	mov    %eax,%edx
  800b2d:	85 d2                	test   %edx,%edx
  800b2f:	78 2b                	js     800b5c <devfile_stat+0x55>
		return r;
	strcpy(st->st_name, fsipcbuf.statRet.ret_name);
  800b31:	c7 44 24 04 00 50 80 	movl   $0x805000,0x4(%esp)
  800b38:	00 
  800b39:	89 1c 24             	mov    %ebx,(%esp)
  800b3c:	e8 2a 0e 00 00       	call   80196b <strcpy>
	st->st_size = fsipcbuf.statRet.ret_size;
  800b41:	a1 80 50 80 00       	mov    0x805080,%eax
  800b46:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	st->st_isdir = fsipcbuf.statRet.ret_isdir;
  800b4c:	a1 84 50 80 00       	mov    0x805084,%eax
  800b51:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
	return 0;
...
devfile_flush(struct Fd *fd)
{
  ...
  800b6b:	8b 40 0c             	mov    0xc(%eax),%eax
  800b6e:	a3 00 50 80 00       	mov    %eax,0x805000
	return fsipc(FSREQ_FLUSH, NULL);
  800b73:	ba 00 00 00 00       	mov    $0x0,%edx
  800b78:	b8 06 00 00 00       	mov    $0x6,%eax
  800b7d:	e8 ed fe ff ff       	call   800a6f <fsipc>
}
  800b82:	c9                   	leave  
  800b83:	c3                   	ret    

00800b84 <devfile_read>:
// Returns:
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b8c:	8b 75 10             	mov    0x10(%ebp),%esi
  ...
  800b9a:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  800ba0:	ba 00 00 00 00       	mov    $0x0,%edx
  800ba5:	b8 03 00 00 00       	mov    $0x3,%eax
  800baa:	e8 c0 fe ff ff       	call   800a6f <fsipc>
  800baf:	89 c3                	mov    %eax,%ebx
  800bb1:	85 c0                	test   %eax,%eax
  800bb3:	78 6a                	js     800c1f <devfile_read+0x9b>
		return r;
	assert(r <= n);
  800bb5:	39 c6                	cmp    %eax,%esi
  800bb7:	73 24                	jae    800bdd <devfile_read+0x59>
  800bb9:	c7 44 24 0c 12 22 80 	movl   $0x802212,0xc(%esp)
  800bc0:	00 
  800bc1:	c7 44 24 08 19 22 80 	movl   $0x802219,0x8(%esp)
  800bc8:	00 
  800bc9:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800bd0:	00 
  800bd1:	c7 04 24 2e 22 80 00 	movl   $0x80222e,(%esp)
  800bd8:	e8 39 06 00 00       	call   801216 <_panic>
	assert(r <= PGSIZE);
  800bdd:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800be2:	7e 24                	jle    800c08 <devfile_read+0x84>
  800be4:	c7 44 24 0c 39 22 80 	movl   $0x802239,0xc(%esp)
  800beb:	00 
  800bec:	c7 44 24 08 19 22 80 	movl   $0x802219,0x8(%esp)
  800bf3:	00 
  800bf4:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800bfb:	00 
  800bfc:	c7 04 24 2e 22 80 00 	movl   $0x80222e,(%esp)
  800c03:	e8 0e 06 00 00       	call   801216 <_panic>
	memmove(buf, &fsipcbuf, r);
  800c08:	89 44 24 08          	mov    %eax,0x8(%esp)
  800c0c:	c7 44 24 04 00 50 80 	movl   $0x805000,0x4(%esp)
  800c13:	00 
  800c14:	8b 45 0c             	mov    0xc(%ebp),%eax
  800c17:	89 04 24             	mov    %eax,(%esp)
  800c1a:	e8 47 0f 00 00       	call   801b66 <memmove>
	return r;
}
...
open(const char *path, int mode)
{
  ...
  800c35:	e8 d6 0c 00 00       	call   801910 <strlen>
  800c3a:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800c3f:	7f 60                	jg     800ca1 <open+0x79>
		return -E_BAD_PATH;

	if ((r = fd_alloc(&fd)) < 0)
  800c41:	8d 45 f4             	lea    -0xc(%ebp),%eax
  800c44:	89 04 24             	mov    %eax,(%esp)
  800c47:	e8 1b f8 ff ff       	call   800467 <fd_alloc>
  800c4c:	89 c2                	mov    %eax,%edx
  800c4e:	85 d2                	test   %edx,%edx
  800c50:	78 54                	js     800ca6 <open+0x7e>
		return r;

	strcpy(fsipcbuf.open.req_path, path);
  800c52:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800c56:	c7 04 24 00 50 80 00 	movl   $0x805000,(%esp)
  800c5d:	e8 09 0d 00 00       	call   80196b <strcpy>
	fsipcbuf.open.req_omode = mode;
  800c62:	8b 45 0c             	mov    0xc(%ebp),%eax
  800c65:	a3 00 54 80 00       	mov    %eax,0x805400

	if ((r = fsipc(FSREQ_OPEN, fd)) < 0) {
  800c6a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800c6d:	b8 01 00 00 00       	mov    $0x1,%eax
  800c72:	e8 f8 fd ff ff       	call   800a6f <fsipc>
  800c77:	89 c3                	mov    %eax,%ebx
  800c79:	85 c0                	test   %eax,%eax
  800c7b:	79 17                	jns    800c94 <open+0x6c>
		fd_close(fd, 0);
  800c7d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800c84:	00 
  800c85:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800c88:	89 04 24             	mov    %eax,(%esp)
  800c8b:	e8 12 f9 ff ff       	call   8005a2 <fd_close>
		return r;
  800c90:	89 d8                	mov    %ebx,%eax
  800c92:	eb 12                	jmp    800ca6 <open+0x7e>
	}
	return fd2num(fd);
  800c94:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800c97:	89 04 24             	mov    %eax,(%esp)
  800c9a:	e8 a1 f7 ff ff       	call   800440 <fd2num>
  800c9f:	eb 05                	jmp    800ca6 <open+0x7e>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  800ca1:	b8 f4 ff ff ff       	mov    $0xfffffff4,%eax
	if ((r = fsipc(FSREQ_OPEN, fd)) < 0) {
		fd_close(fd, 0);
		return r;
	}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800cc1:	e8 8a f7 ff ff       	call   800450 <fd2data>
  800cc6:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  800cc8:	c7 44 24 04 45 22 80 	movl   $0x802245,0x4(%esp)
  800ccf:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800d18:	e8 5d f5 ff ff       	call   80027a <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  800d1d:	89 1c 24             	mov    %ebx,(%esp)
  800d20:	e8 2b f7 ff ff       	call   800450 <fd2data>
  800d25:	89 44 24 04          	mov    %eax,0x4(%esp)
  800d29:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800d30:	e8 45 f5 ff ff       	call   80027a <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d8e:	c7 04 24 4c 22 80 00 	movl   $0x80224c,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800db3:	e8 98 f6 ff ff       	call   800450 <fd2data>
	if (debug)
  ...
  800dd2:	75 54                	jne    800e28 <devpipe_write+0x84>
			...
			sys_yield();
  800dd4:	e8 db f3 ff ff       	call   8001b4 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e44:	e8 07 f6 ff ff       	call   800450 <fd2data>
	if (debug)
  ...
  800e67:	75 43                	jne    800eac <devpipe_read+0x77>
			...
			sys_yield();
  800e69:	e8 46 f3 ff ff       	call   8001b4 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800ec7:	e8 9b f5 ff ff       	call   800467 <fd_alloc>
  ...
  800eec:	e8 e2 f2 ff ff       	call   8001d3 <sys_page_alloc>
  ...
  800f01:	e8 61 f5 ff ff       	call   800467 <fd_alloc>
  ...
  800f26:	e8 a8 f2 ff ff       	call   8001d3 <sys_page_alloc>
  ...
  800f3b:	e8 10 f5 ff ff       	call   800450 <fd2data>
  ...
  800f55:	e8 79 f2 ff ff       	call   8001d3 <sys_page_alloc>
  ...
  800f6a:	e8 e1 f4 ff ff       	call   800450 <fd2data>
  ...
  800f8e:	e8 94 f2 ff ff       	call   800227 <sys_page_map>
...
pipeisclosed(int fdnum)
{
  ...
  80103d:	e8 99 f4 ff ff       	call   8004db <fd_lookup>
  ...
  80104e:	e8 fd f3 ff ff       	call   800450 <fd2data>
	return _pipeisclosed(fd, p);
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801070:	c7 44 24 04 64 22 80 	movl   $0x802264,0x4(%esp)
  801077:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8010d6:	e8 2b f0 ff ff       	call   800106 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801109:	eb 28                	jmp    801133 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  80110b:	e8 a4 f0 ff ff       	call   8001b4 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801110:	e8 0f f0 ff ff       	call   800124 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80114f:	e8 b2 ef ff ff       	call   800106 <sys_cputs>
}
  801154:	c9                   	leave  
  801155:	c3                   	ret    
...
getchar(void)
{
  ...
  801172:	e8 0f f6 ff ff       	call   800786 <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  80119f:	e8 37 f3 ff ff       	call   8004db <fd_lookup>
...
opencons(void)
{
  ...
  8011c7:	e8 9b f2 ff ff       	call   800467 <fd_alloc>
		return r;
...
opencons(void)
{
  ...
  8011e8:	e8 e6 ef ff ff       	call   8001d3 <sys_page_alloc>
		return r;
  ...
  80120b:	e8 30 f2 ff ff       	call   800440 <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801227:	e8 69 ef ff ff       	call   800195 <sys_getenvid>
  ...
  801242:	c7 04 24 70 22 80 00 	movl   $0x802270,(%esp)
  ...
  801258:	e8 51 00 00 00       	call   8012ae <vcprintf>
	cprintf("\n");
  80125d:	c7 04 24 5d 22 80 00 	movl   $0x80225d,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801299:	e8 68 ee ff ff       	call   800106 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801302:	e8 ff ed ff ff       	call   800106 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8013ac:	e8 ef 0a 00 00       	call   801ea0 <__udivdi3>
  ...
  801405:	e8 c6 0b 00 00       	call   801fd0 <__umoddi3>
  80140a:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80140e:	0f be 80 93 22 80 00 	movsbl 0x802293(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80152c:	ff 24 85 e0 23 80 00 	jmp    *0x8023e0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80160e:	c7 44 24 08 2b 22 80 	movl   $0x80222b,0x8(%esp)
  801615:	00 
  ...
  80163d:	ba a4 22 80 00       	mov    $0x8022a4,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d6a:	e8 7a e6 ff ff       	call   8003e9 <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dd1:	c7 44 24 08 a0 25 80 	movl   $0x8025a0,0x8(%esp)
  801dd8:	00 
  801dd9:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801de0:	00 
  801de1:	c7 04 24 ac 25 80 00 	movl   $0x8025ac,(%esp)
  801de8:	e8 29 f4 ff ff       	call   801216 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e09:	e8 b8 e5 ff ff       	call   8003c6 <sys_ipc_try_send>
