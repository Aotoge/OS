...
fsipc(unsigned type, void *dstva)
{
  ...
  800abb:	e8 c5 13 00 00       	call   801e85 <ipc_find_env>
  ...
  800ae1:	e8 39 13 00 00       	call   801e1f <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800bc6:	00 
  800bc7:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800bce:	00 
  ...
  800bf1:	00 
  800bf2:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800bf9:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801dc6:	83 f8 01             	cmp    $0x1,%eax
  801dc9:	19 c0                	sbb    %eax,%eax
  801dcb:	f7 d0                	not    %eax
  801dcd:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801dd2:	89 04 24             	mov    %eax,(%esp)
  801dd5:	e8 f3 e5 ff ff       	call   8003cd <sys_ipc_recv>
	if (err_code < 0) {
  801dda:	85 c0                	test   %eax,%eax
  801ddc:	79 16                	jns    801df4 <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801dde:	85 f6                	test   %esi,%esi
  801de0:	74 06                	je     801de8 <ipc_recv+0x33>
  801de2:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801de8:	85 db                	test   %ebx,%ebx
  801dea:	74 2c                	je     801e18 <ipc_recv+0x63>
  801dec:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801df2:	eb 24                	jmp    801e18 <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801df4:	85 f6                	test   %esi,%esi
  801df6:	74 0a                	je     801e02 <ipc_recv+0x4d>
  801df8:	a1 04 40 80 00       	mov    0x804004,%eax
  801dfd:	8b 40 74             	mov    0x74(%eax),%eax
  801e00:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801e02:	85 db                	test   %ebx,%ebx
  801e04:	74 0a                	je     801e10 <ipc_recv+0x5b>
  801e06:	a1 04 40 80 00       	mov    0x804004,%eax
  801e0b:	8b 40 78             	mov    0x78(%eax),%eax
  801e0e:	89 03                	mov    %eax,(%ebx)
	}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e31:	eb 25                	jmp    801e58 <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801e33:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e36:	74 20                	je     801e58 <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801e38:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e3c:	c7 44 24 08 12 26 80 	movl   $0x802612,0x8(%esp)
  801e43:	00 
  801e44:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801e4b:	00 
  801e4c:	c7 04 24 1e 26 80 00 	movl   $0x80261e,(%esp)
  801e53:	e8 be f3 ff ff       	call   801216 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e5a:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801e5f:	0f 45 c3             	cmovne %ebx,%eax
  801e62:	8b 55 14             	mov    0x14(%ebp),%edx
  801e65:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801e69:	89 44 24 08          	mov    %eax,0x8(%esp)
  801e6d:	89 74 24 04          	mov    %esi,0x4(%esp)
  801e71:	89 3c 24             	mov    %edi,(%esp)
  801e74:	e8 31 e5 ff ff       	call   8003aa <sys_ipc_try_send>
  801e79:	85 c0                	test   %eax,%eax
  801e7b:	75 b6                	jne    801e33 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e8b:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801e90:	39 c8                	cmp    %ecx,%eax
  801e92:	74 17                	je     801eab <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801ea7:	75 14                	jne    801ebd <ipc_find_env+0x38>
  801ea9:	eb 05                	jmp    801eb0 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801eb3:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801eb8:	8b 40 40             	mov    0x40(%eax),%eax
  801ebb:	eb 0e                	jmp    801ecb <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801ec0:	3d 00 04 00 00       	cmp    $0x400,%eax
  801ec5:	75 d2                	jne    801e99 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801ec7:	66 b8 00 00          	mov    $0x0,%ax
}
  801ecb:	5d                   	pop    %ebp
  801ecc:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801ed8:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801ee4:	f6 c1 01             	test   $0x1,%cl
  801ee7:	74 1d                	je     801f06 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801ee9:	c1 ea 0c             	shr    $0xc,%edx
  801eec:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801ef3:	f6 c2 01             	test   $0x1,%dl
  801ef6:	74 0e                	je     801f06 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801ef8:	c1 ea 0c             	shr    $0xc,%edx
  801efb:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801f02:	ef 
  801f03:	0f b7 c0             	movzwl %ax,%eax
}
  801f06:	5d                   	pop    %ebp
  801f07:	c3                   	ret    
