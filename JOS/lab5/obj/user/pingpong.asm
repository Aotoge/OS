...
umain(int argc, char **argv)
{
  ...
  800081:	e8 d0 12 00 00       	call   801356 <ipc_send>
	}
  ...
  8000e5:	e8 6c 12 00 00       	call   801356 <ipc_send>
		if (i == 10)
...
duppage(envid_t envid, unsigned pn)
{
  ...
  801176:	e8 3b 10 00 00       	call   8021b6 <_panic>
		}
  ...
  8011ba:	e8 f7 0f 00 00       	call   8021b6 <_panic>
		}
  ...
  8011fe:	e8 b3 0f 00 00       	call   8021b6 <_panic>
	}
  ...
  801212:	c7 44 24 04 75 22 80 	movl   $0x802275,0x4(%esp)
  801219:	00 
  ...
  801244:	e8 6d 0f 00 00       	call   8021b6 <_panic>
	}
  ...
  801283:	e8 2e 0f 00 00       	call   8021b6 <_panic>
	}
  ...
  8012ba:	e8 f7 0e 00 00       	call   8021b6 <_panic>
	}
...
sfork(void)
{
  ...
  8012e7:	e8 ca 0e 00 00       	call   8021b6 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801300:	19 c0                	sbb    %eax,%eax
  801302:	f7 d0                	not    %eax
  801304:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801309:	89 04 24             	mov    %eax,(%esp)
  80130c:	e8 3e fc ff ff       	call   800f4f <sys_ipc_recv>
	if (err_code < 0) {
  801311:	85 c0                	test   %eax,%eax
  801313:	79 16                	jns    80132b <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801315:	85 f6                	test   %esi,%esi
  801317:	74 06                	je     80131f <ipc_recv+0x33>
  801319:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  80131f:	85 db                	test   %ebx,%ebx
  801321:	74 2c                	je     80134f <ipc_recv+0x63>
  801323:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801329:	eb 24                	jmp    80134f <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  80132b:	85 f6                	test   %esi,%esi
  80132d:	74 0a                	je     801339 <ipc_recv+0x4d>
  80132f:	a1 04 40 80 00       	mov    0x804004,%eax
  801334:	8b 40 74             	mov    0x74(%eax),%eax
  801337:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801339:	85 db                	test   %ebx,%ebx
  80133b:	74 0a                	je     801347 <ipc_recv+0x5b>
  80133d:	a1 04 40 80 00       	mov    0x804004,%eax
  801342:	8b 40 78             	mov    0x78(%eax),%eax
  801345:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  801347:	a1 04 40 80 00       	mov    0x804004,%eax
  80134c:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801368:	eb 25                	jmp    80138f <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  80136a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80136d:	74 20                	je     80138f <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  80136f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801373:	c7 44 24 08 3b 2a 80 	movl   $0x802a3b,0x8(%esp)
  80137a:	00 
  80137b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801382:	00 
  801383:	c7 04 24 47 2a 80 00 	movl   $0x802a47,(%esp)
  80138a:	e8 27 0e 00 00       	call   8021b6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801396:	0f 45 c3             	cmovne %ebx,%eax
  ...
  8013a8:	89 3c 24             	mov    %edi,(%esp)
  8013ab:	e8 7c fb ff ff       	call   800f2c <sys_ipc_try_send>
  8013b0:	85 c0                	test   %eax,%eax
  8013b2:	75 b6                	jne    80136a <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  8013c2:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  8013c7:	39 c8                	cmp    %ecx,%eax
  8013c9:	74 17                	je     8013e2 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8013cb:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  8013d0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8013d3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8013d9:	8b 52 50             	mov    0x50(%edx),%edx
  8013dc:	39 ca                	cmp    %ecx,%edx
  8013de:	75 14                	jne    8013f4 <ipc_find_env+0x38>
  8013e0:	eb 05                	jmp    8013e7 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8013e7:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8013ea:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8013ef:	8b 40 40             	mov    0x40(%eax),%eax
  8013f2:	eb 0e                	jmp    801402 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  8013f4:	83 c0 01             	add    $0x1,%eax
  8013f7:	3d 00 04 00 00       	cmp    $0x400,%eax
  8013fc:	75 d2                	jne    8013d0 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8013fe:	66 b8 00 00          	mov    $0x0,%ax
}
  801402:	5d                   	pop    %ebp
  801403:	c3                   	ret    
...
fsipc(unsigned type, void *dstva)
{
  ...
  801a5b:	e8 5c f9 ff ff       	call   8013bc <ipc_find_env>
  ...
  801a81:	e8 d0 f8 ff ff       	call   801356 <ipc_send>
  ...
  801a99:	e8 4e f8 ff ff       	call   8012ec <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801b66:	00 
  801b67:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801b6e:	00 
  ...
  801b91:	00 
  801b92:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801b99:	00 
