...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 00 	movl   $0x802100,0x803000
  800040:	21 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800145:	00 
  800146:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  80014d:	00 
  80014e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800155:	00 
  800156:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  80015d:	e8 84 10 00 00       	call   8011e6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001d7:	00 
  8001d8:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  8001df:	00 
  8001e0:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001e7:	00 
  8001e8:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  8001ef:	e8 f2 0f 00 00       	call   8011e6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80022a:	00 
  80022b:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  800232:	00 
  800233:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80023a:	00 
  80023b:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  800242:	e8 9f 0f 00 00       	call   8011e6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80027d:	00 
  80027e:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  800285:	00 
  800286:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80028d:	00 
  80028e:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  800295:	e8 4c 0f 00 00       	call   8011e6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002d0:	00 
  8002d1:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  8002d8:	00 
  8002d9:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002e0:	00 
  8002e1:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  8002e8:	e8 f9 0e 00 00       	call   8011e6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800323:	00 
  800324:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  80032b:	00 
  80032c:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800333:	00 
  800334:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  80033b:	e8 a6 0e 00 00       	call   8011e6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800376:	00 
  800377:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  80037e:	00 
  80037f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800386:	00 
  800387:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  80038e:	e8 53 0e 00 00       	call   8011e6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003eb:	00 
  8003ec:	c7 44 24 08 0f 21 80 	movl   $0x80210f,0x8(%esp)
  8003f3:	00 
  8003f4:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003fb:	00 
  8003fc:	c7 04 24 2c 21 80 00 	movl   $0x80212c,(%esp)
  800403:	e8 de 0d 00 00       	call   8011e6 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800555:	c7 04 24 3c 21 80 00 	movl   $0x80213c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007ab:	c7 04 24 7d 21 80 00 	movl   $0x80217d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800893:	c7 04 24 99 21 80 00 	movl   $0x802199,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80094c:	c7 04 24 5c 21 80 00 	movl   $0x80215c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a7f:	c7 04 24 b6 21 80 00 	movl   $0x8021b6,(%esp)
  ...
  800aa7:	e8 d8 12 00 00       	call   801d84 <ipc_send>
	cprintf("ipc_send\n");
  800aac:	c7 04 24 cc 21 80 00 	movl   $0x8021cc,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b89:	c7 44 24 0c d6 21 80 	movl   $0x8021d6,0xc(%esp)
  800b90:	00 
  800b91:	c7 44 24 08 dd 21 80 	movl   $0x8021dd,0x8(%esp)
  800b98:	00 
  800b99:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800ba0:	00 
  800ba1:	c7 04 24 f2 21 80 00 	movl   $0x8021f2,(%esp)
  800ba8:	e8 39 06 00 00       	call   8011e6 <_panic>
	assert(r <= PGSIZE);
  800bad:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800bb2:	7e 24                	jle    800bd8 <devfile_read+0x84>
  800bb4:	c7 44 24 0c fd 21 80 	movl   $0x8021fd,0xc(%esp)
  800bbb:	00 
  800bbc:	c7 44 24 08 dd 21 80 	movl   $0x8021dd,0x8(%esp)
  800bc3:	00 
  800bc4:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800bcb:	00 
  800bcc:	c7 04 24 f2 21 80 00 	movl   $0x8021f2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c98:	c7 44 24 04 09 22 80 	movl   $0x802209,0x4(%esp)
  800c9f:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800ce8:	e8 62 f5 ff ff       	call   80024f <sys_page_unmap>
  ...
  800d00:	e8 4a f5 ff ff       	call   80024f <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d5e:	c7 04 24 10 22 80 00 	movl   $0x802210,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800da2:	75 54                	jne    800df8 <devpipe_write+0x84>
			...
			sys_yield();
  800da4:	e8 e0 f3 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e37:	75 43                	jne    800e7c <devpipe_read+0x77>
			...
			sys_yield();
  800e39:	e8 4b f3 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800ebc:	e8 e7 f2 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800ef6:	e8 ad f2 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800f25:	e8 7e f2 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800f5e:	e8 99 f2 ff ff       	call   8001fc <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801040:	c7 44 24 04 28 22 80 	movl   $0x802228,0x4(%esp)
  801047:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8010a6:	e8 30 f0 ff ff       	call   8000db <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010d9:	eb 28                	jmp    801103 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010db:	e8 a9 f0 ff ff       	call   800189 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010e0:	e8 14 f0 ff ff       	call   8000f9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80111f:	e8 b7 ef ff ff       	call   8000db <sys_cputs>
}
  801124:	c9                   	leave  
  801125:	c3                   	ret    
...
opencons(void)
{
  ...
  8011b8:	e8 eb ef ff ff       	call   8001a8 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011f7:	e8 6e ef ff ff       	call   80016a <sys_getenvid>
  ...
  801212:	c7 04 24 34 22 80 00 	movl   $0x802234,(%esp)
  ...
  801228:	e8 51 00 00 00       	call   80127e <vcprintf>
	cprintf("\n");
  80122d:	c7 04 24 21 22 80 00 	movl   $0x802221,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801269:	e8 6d ee ff ff       	call   8000db <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012d2:	e8 04 ee ff ff       	call   8000db <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8013de:	0f be 80 57 22 80 00 	movsbl 0x802257(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8015be:	c7 44 24 08 6f 22 80 	movl   $0x80226f,0x8(%esp)
  8015c5:	00 
  ...
  8015de:	c7 44 24 08 ef 21 80 	movl   $0x8021ef,0x8(%esp)
  8015e5:	00 
  ...
  80160d:	ba 68 22 80 00       	mov    $0x802268,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d3a:	e8 7f e6 ff ff       	call   8003be <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dd9:	e8 bd e5 ff ff       	call   80039b <sys_ipc_try_send>
