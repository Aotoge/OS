...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 e0 	movl   $0x8020e0,0x803000
  800040:	20 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 41 01 00 00       	call   800189 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800058:	e8 0d 01 00 00       	call   80016a <sys_getenvid>
	for (i = 0; i < NENV; ++i) {
		if (envs[i].env_id == current_id) {
  80005d:	8b 15 48 00 c0 ee    	mov    0xeec00048,%edx
  800063:	39 c2                	cmp    %eax,%edx
  800065:	74 17                	je     80007e <libmain+0x34>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
  ...
  800067:	ba 01 00 00 00       	mov    $0x1,%edx
		if (envs[i].env_id == current_id) {
  80006c:	6b ca 7c             	imul   $0x7c,%edx,%ecx
  80006f:	81 c1 08 00 c0 ee    	add    $0xeec00008,%ecx
  800075:	8b 49 40             	mov    0x40(%ecx),%ecx
  800078:	39 c1                	cmp    %eax,%ecx
  80007a:	75 18                	jne    800094 <libmain+0x4a>
  80007c:	eb 05                	jmp    800083 <libmain+0x39>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
	envid_t current_id = sys_getenvid();
	for (i = 0; i < NENV; ++i) {
  80007e:	ba 00 00 00 00       	mov    $0x0,%edx
		if (envs[i].env_id == current_id) {
		// if (envs[i].env_status == ENV_RUNNING) {
			thisenv = envs + i;
  800083:	6b d2 7c             	imul   $0x7c,%edx,%edx
  800086:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80008c:	89 15 04 40 80 00    	mov    %edx,0x804004
			break;
  800092:	eb 0b                	jmp    80009f <libmain+0x55>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
  ...
  80009d:	75 cd                	jne    80006c <libmain+0x22>
  ...
  8000a1:	7e 07                	jle    8000aa <libmain+0x60>
		binaryname = argv[0];
  ...
  8000b1:	e8 7d ff ff ff       	call   800033 <umain>
	...
	// exit gracefully
	exit();
  8000b6:	e8 07 00 00 00       	call   8000c2 <exit>
}
...
exit(void)
{
  ...
  8000c5:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000c8:	e8 59 05 00 00       	call   800626 <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800145:	00 
  800146:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  80014d:	00 
  80014e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800155:	00 
  800156:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80015d:	e8 54 10 00 00       	call   8011b6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001d7:	00 
  8001d8:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8001df:	00 
  8001e0:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001e7:	00 
  8001e8:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  8001ef:	e8 c2 0f 00 00       	call   8011b6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80022a:	00 
  80022b:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800232:	00 
  800233:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80023a:	00 
  80023b:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800242:	e8 6f 0f 00 00       	call   8011b6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80027d:	00 
  80027e:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800285:	00 
  800286:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80028d:	00 
  80028e:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800295:	e8 1c 0f 00 00       	call   8011b6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002d0:	00 
  8002d1:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8002d8:	00 
  8002d9:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002e0:	00 
  8002e1:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  8002e8:	e8 c9 0e 00 00       	call   8011b6 <_panic>
...
008002f5 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800316:	7e 28                	jle    800340 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800318:	89 44 24 10          	mov    %eax,0x10(%esp)
  80031c:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800323:	00 
  800324:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  80032b:	00 
  80032c:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800333:	00 
  800334:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80033b:	e8 76 0e 00 00       	call   8011b6 <_panic>
...
00800348 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800369:	7e 28                	jle    800393 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80036b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80036f:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800376:	00 
  800377:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  80037e:	00 
  80037f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800386:	00 
  800387:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80038e:	e8 23 0e 00 00       	call   8011b6 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003a6:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  8003d1:	8b 55 08             	mov    0x8(%ebp),%edx
  8003d4:	89 cb                	mov    %ecx,%ebx
  8003d6:	89 cf                	mov    %ecx,%edi
  8003d8:	89 ce                	mov    %ecx,%esi
  ...
  8003de:	7e 28                	jle    800408 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003e0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003e4:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003eb:	00 
  8003ec:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8003f3:	00 
  8003f4:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003fb:	00 
  8003fc:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800403:	e8 ae 0d 00 00       	call   8011b6 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800555:	c7 04 24 1c 21 80 00 	movl   $0x80211c,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8005e5:	e8 65 fc ff ff       	call   80024f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006e3:	e8 14 fb ff ff       	call   8001fc <sys_page_map>
  ...
  80071e:	e8 d9 fa ff ff       	call   8001fc <sys_page_map>
...
err:
  ...
  800737:	e8 13 fb ff ff       	call   80024f <sys_page_unmap>
	sys_page_unmap(0, nva);
  80073c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800740:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800747:	e8 03 fb ff ff       	call   80024f <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007ab:	c7 04 24 5d 21 80 00 	movl   $0x80215d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800893:	c7 04 24 79 21 80 00 	movl   $0x802179,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80094c:	c7 04 24 3c 21 80 00 	movl   $0x80213c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a5b:	e8 5c 13 00 00       	call   801dbc <ipc_find_env>
  ...
  800a81:	e8 d0 12 00 00       	call   801d56 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b57:	c7 44 24 0c 96 21 80 	movl   $0x802196,0xc(%esp)
  800b5e:	00 
  800b5f:	c7 44 24 08 9d 21 80 	movl   $0x80219d,0x8(%esp)
  800b66:	00 
  800b67:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800b6e:	00 
  800b6f:	c7 04 24 b2 21 80 00 	movl   $0x8021b2,(%esp)
  800b76:	e8 3b 06 00 00       	call   8011b6 <_panic>
	assert(r <= PGSIZE);
  800b7b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b80:	7e 24                	jle    800ba6 <devfile_read+0x84>
  800b82:	c7 44 24 0c bd 21 80 	movl   $0x8021bd,0xc(%esp)
  800b89:	00 
  800b8a:	c7 44 24 08 9d 21 80 	movl   $0x80219d,0x8(%esp)
  800b91:	00 
  800b92:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  800b99:	00 
  800b9a:	c7 04 24 b2 21 80 00 	movl   $0x8021b2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c68:	c7 44 24 04 c9 21 80 	movl   $0x8021c9,0x4(%esp)
  800c6f:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800cb8:	e8 92 f5 ff ff       	call   80024f <sys_page_unmap>
  ...
  800cd0:	e8 7a f5 ff ff       	call   80024f <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d2e:	c7 04 24 d0 21 80 00 	movl   $0x8021d0,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d72:	75 54                	jne    800dc8 <devpipe_write+0x84>
			...
			sys_yield();
  800d74:	e8 10 f4 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e07:	75 43                	jne    800e4c <devpipe_read+0x77>
			...
			sys_yield();
  800e09:	e8 7b f3 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e8c:	e8 17 f3 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800ec6:	e8 dd f2 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800ef5:	e8 ae f2 ff ff       	call   8001a8 <sys_page_alloc>
  ...
  800f2e:	e8 c9 f2 ff ff       	call   8001fc <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801010:	c7 44 24 04 e8 21 80 	movl   $0x8021e8,0x4(%esp)
  801017:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801076:	e8 60 f0 ff ff       	call   8000db <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010a9:	eb 28                	jmp    8010d3 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010ab:	e8 d9 f0 ff ff       	call   800189 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010b0:	e8 44 f0 ff ff       	call   8000f9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8010ef:	e8 e7 ef ff ff       	call   8000db <sys_cputs>
}
  8010f4:	c9                   	leave  
  8010f5:	c3                   	ret    
...
opencons(void)
{
  ...
  801188:	e8 1b f0 ff ff       	call   8001a8 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011c7:	e8 9e ef ff ff       	call   80016a <sys_getenvid>
  ...
  8011e2:	c7 04 24 f4 21 80 00 	movl   $0x8021f4,(%esp)
  ...
  8011f8:	e8 51 00 00 00       	call   80124e <vcprintf>
	cprintf("\n");
  8011fd:	c7 04 24 e1 21 80 00 	movl   $0x8021e1,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801239:	e8 9d ee ff ff       	call   8000db <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012a2:	e8 34 ee ff ff       	call   8000db <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8013ae:	0f be 80 17 22 80 00 	movsbl 0x802217(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80158e:	c7 44 24 08 2f 22 80 	movl   $0x80222f,0x8(%esp)
  801595:	00 
  ...
  8015ae:	c7 44 24 08 af 21 80 	movl   $0x8021af,0x8(%esp)
  8015b5:	00 
  ...
  8015dd:	ba 28 22 80 00       	mov    $0x802228,%edx
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cfd:	83 f8 01             	cmp    $0x1,%eax
  801d00:	19 c0                	sbb    %eax,%eax
  801d02:	f7 d0                	not    %eax
  801d04:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801d09:	89 04 24             	mov    %eax,(%esp)
  801d0c:	e8 ad e6 ff ff       	call   8003be <sys_ipc_recv>
	if (err_code < 0) {
  801d11:	85 c0                	test   %eax,%eax
  801d13:	79 16                	jns    801d2b <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801d15:	85 f6                	test   %esi,%esi
  801d17:	74 06                	je     801d1f <ipc_recv+0x33>
  801d19:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801d1f:	85 db                	test   %ebx,%ebx
  801d21:	74 2c                	je     801d4f <ipc_recv+0x63>
  801d23:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d29:	eb 24                	jmp    801d4f <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801d2b:	85 f6                	test   %esi,%esi
  801d2d:	74 0a                	je     801d39 <ipc_recv+0x4d>
  801d2f:	a1 04 40 80 00       	mov    0x804004,%eax
  801d34:	8b 40 74             	mov    0x74(%eax),%eax
  801d37:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801d39:	85 db                	test   %ebx,%ebx
  801d3b:	74 0a                	je     801d47 <ipc_recv+0x5b>
  801d3d:	a1 04 40 80 00       	mov    0x804004,%eax
  801d42:	8b 40 78             	mov    0x78(%eax),%eax
  801d45:	89 03                	mov    %eax,(%ebx)
	}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d68:	eb 25                	jmp    801d8f <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801d6a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d6d:	74 20                	je     801d8f <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801d6f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801d73:	c7 44 24 08 20 25 80 	movl   $0x802520,0x8(%esp)
  801d7a:	00 
  801d7b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801d82:	00 
  801d83:	c7 04 24 2c 25 80 00 	movl   $0x80252c,(%esp)
  801d8a:	e8 27 f4 ff ff       	call   8011b6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d96:	0f 45 c3             	cmovne %ebx,%eax
  801d99:	8b 55 14             	mov    0x14(%ebp),%edx
  801d9c:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801da0:	89 44 24 08          	mov    %eax,0x8(%esp)
  801da4:	89 74 24 04          	mov    %esi,0x4(%esp)
  801da8:	89 3c 24             	mov    %edi,(%esp)
  801dab:	e8 eb e5 ff ff       	call   80039b <sys_ipc_try_send>
  801db0:	85 c0                	test   %eax,%eax
  801db2:	75 b6                	jne    801d6a <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801dc2:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801dc7:	39 c8                	cmp    %ecx,%eax
  801dc9:	74 17                	je     801de2 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801dcb:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801dd0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801dd3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801dd9:	8b 52 50             	mov    0x50(%edx),%edx
  801ddc:	39 ca                	cmp    %ecx,%edx
  801dde:	75 14                	jne    801df4 <ipc_find_env+0x38>
  801de0:	eb 05                	jmp    801de7 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801dea:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801def:	8b 40 40             	mov    0x40(%eax),%eax
  801df2:	eb 0e                	jmp    801e02 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801dfc:	75 d2                	jne    801dd0 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801dfe:	66 b8 00 00          	mov    $0x0,%ax
}
  801e02:	5d                   	pop    %ebp
  801e03:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e0c:	c1 e8 16             	shr    $0x16,%eax
  801e0f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e1b:	f6 c1 01             	test   $0x1,%cl
  801e1e:	74 1d                	je     801e3d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e20:	c1 ea 0c             	shr    $0xc,%edx
  801e23:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e2a:	f6 c2 01             	test   $0x1,%dl
  801e2d:	74 0e                	je     801e3d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e2f:	c1 ea 0c             	shr    $0xc,%edx
  801e32:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e39:	ef 
  801e3a:	0f b7 c0             	movzwl %ax,%eax
}
  801e3d:	5d                   	pop    %ebp
  801e3e:	c3                   	ret    
  801e3f:	90                   	nop
