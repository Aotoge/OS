...
fsipc(unsigned type, void *dstva)
{
  ...
  80159b:	e8 7c 08 00 00       	call   801e1c <ipc_find_env>
  ...
  8015c1:	e8 f0 07 00 00       	call   801db6 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8016a6:	00 
  8016a7:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  8016ae:	00 
  ...
  8016d1:	00 
  8016d2:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  8016d9:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d60:	19 c0                	sbb    %eax,%eax
  801d62:	f7 d0                	not    %eax
  801d64:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801d69:	89 04 24             	mov    %eax,(%esp)
  801d6c:	e8 7e f1 ff ff       	call   800eef <sys_ipc_recv>
	if (err_code < 0) {
  801d71:	85 c0                	test   %eax,%eax
  801d73:	79 16                	jns    801d8b <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801d75:	85 f6                	test   %esi,%esi
  801d77:	74 06                	je     801d7f <ipc_recv+0x33>
  801d79:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801d7f:	85 db                	test   %ebx,%ebx
  801d81:	74 2c                	je     801daf <ipc_recv+0x63>
  801d83:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d89:	eb 24                	jmp    801daf <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801d8b:	85 f6                	test   %esi,%esi
  801d8d:	74 0a                	je     801d99 <ipc_recv+0x4d>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dc8:	eb 25                	jmp    801def <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801dca:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801dcd:	74 20                	je     801def <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801dcf:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801dd3:	c7 44 24 08 e8 25 80 	movl   $0x8025e8,0x8(%esp)
  801dda:	00 
  801ddb:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801de2:	00 
  801de3:	c7 04 24 f4 25 80 00 	movl   $0x8025f4,(%esp)
  801dea:	e8 07 ff ff ff       	call   801cf6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801df1:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801df6:	0f 45 c3             	cmovne %ebx,%eax
  801df9:	8b 55 14             	mov    0x14(%ebp),%edx
  801dfc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801e00:	89 44 24 08          	mov    %eax,0x8(%esp)
  801e04:	89 74 24 04          	mov    %esi,0x4(%esp)
  801e08:	89 3c 24             	mov    %edi,(%esp)
  801e0b:	e8 bc f0 ff ff       	call   800ecc <sys_ipc_try_send>
  801e10:	85 c0                	test   %eax,%eax
  801e12:	75 b6                	jne    801dca <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e22:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801e27:	39 c8                	cmp    %ecx,%eax
  801e29:	74 17                	je     801e42 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e2b:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801e30:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801e33:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801e39:	8b 52 50             	mov    0x50(%edx),%edx
  801e3c:	39 ca                	cmp    %ecx,%edx
  801e3e:	75 14                	jne    801e54 <ipc_find_env+0x38>
  801e40:	eb 05                	jmp    801e47 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e47:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e4a:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801e4f:	8b 40 40             	mov    0x40(%eax),%eax
  801e52:	eb 0e                	jmp    801e62 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e57:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e5c:	75 d2                	jne    801e30 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801e5e:	66 b8 00 00          	mov    $0x0,%ax
}
  801e62:	5d                   	pop    %ebp
  801e63:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e6c:	c1 e8 16             	shr    $0x16,%eax
  801e6f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e7b:	f6 c1 01             	test   $0x1,%cl
  801e7e:	74 1d                	je     801e9d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e80:	c1 ea 0c             	shr    $0xc,%edx
  801e83:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e8a:	f6 c2 01             	test   $0x1,%dl
  801e8d:	74 0e                	je     801e9d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e8f:	c1 ea 0c             	shr    $0xc,%edx
  801e92:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e99:	ef 
  801e9a:	0f b7 c0             	movzwl %ax,%eax
}
  801e9d:	5d                   	pop    %ebp
  801e9e:	c3                   	ret    
  801e9f:	90                   	nop
