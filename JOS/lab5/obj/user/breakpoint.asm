...
libmain(int argc, char **argv)
{
  ...
  80004c:	8b 15 48 00 c0 ee    	mov    0xeec00048,%edx
  800052:	39 c2                	cmp    %eax,%edx
  800054:	74 17                	je     80006d <libmain+0x34>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
	envid_t current_id = sys_getenvid();
	for (i = 0; i < NENV; ++i) {
  800056:	ba 01 00 00 00       	mov    $0x1,%edx
		if (envs[i].env_id == current_id) {
  80005b:	6b ca 7c             	imul   $0x7c,%edx,%ecx
  80005e:	81 c1 08 00 c0 ee    	add    $0xeec00008,%ecx
  800064:	8b 49 40             	mov    0x40(%ecx),%ecx
  800067:	39 c1                	cmp    %eax,%ecx
  800069:	75 18                	jne    800083 <libmain+0x4a>
  80006b:	eb 05                	jmp    800072 <libmain+0x39>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
  ...
  80006d:	ba 00 00 00 00       	mov    $0x0,%edx
		...
		// if (envs[i].env_status == ENV_RUNNING) {
			thisenv = envs + i;
  800072:	6b d2 7c             	imul   $0x7c,%edx,%edx
  800075:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80007b:	89 15 04 40 80 00    	mov    %edx,0x804004
			break;
  800081:	eb 0b                	jmp    80008e <libmain+0x55>
libmain(int argc, char **argv)
{
	// set thisenv to point at our Env structure in envs[].
	int i;
  ...
  80008c:	75 cd                	jne    80005b <libmain+0x22>
  ...
  800090:	7e 07                	jle    800099 <libmain+0x60>
		binaryname = argv[0];
...
exit(void)
{
  ...
  8000b4:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b7:	e8 5a 05 00 00       	call   800616 <close_all>
	sys_env_destroy(0);
  8000bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000c3:	e8 3f 00 00 00       	call   800107 <sys_env_destroy>
}
  8000c8:	c9                   	leave  
  8000c9:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800127:	7e 28                	jle    800151 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800129:	89 44 24 10          	mov    %eax,0x10(%esp)
  80012d:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800134:	00 
  800135:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  80013c:	00 
  80013d:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800144:	00 
  800145:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  80014c:	e8 55 10 00 00       	call   8011a6 <_panic>
...
sys_yield(void)
{
  ...
  800183:	b8 0b 00 00 00       	mov    $0xb,%eax
  800188:	89 d1                	mov    %edx,%ecx
  80018a:	89 d3                	mov    %edx,%ebx
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b9:	7e 28                	jle    8001e3 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001bb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001bf:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001c6:	00 
  8001c7:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  8001ce:	00 
  8001cf:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001d6:	00 
  8001d7:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  8001de:	e8 c3 0f 00 00       	call   8011a6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80020c:	7e 28                	jle    800236 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80020e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800212:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800219:	00 
  80021a:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  800221:	00 
  800222:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800229:	00 
  80022a:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  800231:	e8 70 0f 00 00       	call   8011a6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80025f:	7e 28                	jle    800289 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800261:	89 44 24 10          	mov    %eax,0x10(%esp)
  800265:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80026c:	00 
  80026d:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  800274:	00 
  800275:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80027c:	00 
  80027d:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  800284:	e8 1d 0f 00 00       	call   8011a6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029f:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  8002b2:	7e 28                	jle    8002dc <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002b4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002b8:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  8002bf:	00 
  8002c0:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  8002c7:	00 
  8002c8:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002cf:	00 
  8002d0:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  8002d7:	e8 ca 0e 00 00       	call   8011a6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800305:	7e 28                	jle    80032f <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800307:	89 44 24 10          	mov    %eax,0x10(%esp)
  80030b:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800312:	00 
  800313:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  80031a:	00 
  80031b:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800322:	00 
  800323:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  80032a:	e8 77 0e 00 00       	call   8011a6 <_panic>
...
00800337 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800358:	7e 28                	jle    800382 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80035e:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800365:	00 
  800366:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  80036d:	00 
  80036e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800375:	00 
  800376:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  80037d:	e8 24 0e 00 00       	call   8011a6 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80038f:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  800390:	be 00 00 00 00       	mov    $0x0,%esi
  800395:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bb:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003c0:	8b 55 08             	mov    0x8(%ebp),%edx
  8003c3:	89 cb                	mov    %ecx,%ebx
  8003c5:	89 cf                	mov    %ecx,%edi
  8003c7:	89 ce                	mov    %ecx,%esi
  ...
  8003cd:	7e 28                	jle    8003f7 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003cf:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003d3:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003da:	00 
  8003db:	c7 44 24 08 ca 20 80 	movl   $0x8020ca,0x8(%esp)
  8003e2:	00 
  8003e3:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003ea:	00 
  8003eb:	c7 04 24 e7 20 80 00 	movl   $0x8020e7,(%esp)
  8003f2:	e8 af 0d 00 00       	call   8011a6 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8005d5:	e8 64 fc ff ff       	call   80023e <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8006d3:	e8 13 fb ff ff       	call   8001eb <sys_page_map>
  ...
  80070e:	e8 d8 fa ff ff       	call   8001eb <sys_page_map>
...
err:
  ...
  800727:	e8 12 fb ff ff       	call   80023e <sys_page_unmap>
	sys_page_unmap(0, nva);
  80072c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800730:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800737:	e8 02 fb ff ff       	call   80023e <sys_page_unmap>
	return r;
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a4b:	e8 5a 13 00 00       	call   801daa <ipc_find_env>
  ...
  800a71:	e8 ce 12 00 00       	call   801d44 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b56:	00 
  800b57:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  800b5e:	00 
  ...
  800b81:	00 
  800b82:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  800b89:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800ca8:	e8 91 f5 ff ff       	call   80023e <sys_page_unmap>
  ...
  800cc0:	e8 79 f5 ff ff       	call   80023e <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d62:	75 54                	jne    800db8 <devpipe_write+0x84>
			...
			sys_yield();
  800d64:	e8 0f f4 ff ff       	call   800178 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800df7:	75 43                	jne    800e3c <devpipe_read+0x77>
			...
			sys_yield();
  800df9:	e8 7a f3 ff ff       	call   800178 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e7c:	e8 16 f3 ff ff       	call   800197 <sys_page_alloc>
  ...
  800eb6:	e8 dc f2 ff ff       	call   800197 <sys_page_alloc>
  ...
  800ee5:	e8 ad f2 ff ff       	call   800197 <sys_page_alloc>
  ...
  800f1e:	e8 c8 f2 ff ff       	call   8001eb <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801066:	e8 5f f0 ff ff       	call   8000ca <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801099:	eb 28                	jmp    8010c3 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  80109b:	e8 d8 f0 ff ff       	call   800178 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010a0:	e8 43 f0 ff ff       	call   8000e8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8010df:	e8 e6 ef ff ff       	call   8000ca <sys_cputs>
}
  8010e4:	c9                   	leave  
  8010e5:	c3                   	ret    
...
opencons(void)
{
  ...
  801178:	e8 1a f0 ff ff       	call   800197 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011b7:	e8 9d ef ff ff       	call   800159 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801229:	e8 9c ee ff ff       	call   8000ca <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801292:	e8 33 ee ff ff       	call   8000ca <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801cef:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801cf4:	0f 44 c2             	cmove  %edx,%eax
  801cf7:	89 04 24             	mov    %eax,(%esp)
  801cfa:	e8 ae e6 ff ff       	call   8003ad <sys_ipc_recv>
	if (err_code < 0) {
  801cff:	85 c0                	test   %eax,%eax
  801d01:	79 16                	jns    801d19 <ipc_recv+0x3d>
		if (from_env_store) *from_env_store = 0;
  801d03:	85 f6                	test   %esi,%esi
  801d05:	74 06                	je     801d0d <ipc_recv+0x31>
  801d07:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801d0d:	85 db                	test   %ebx,%ebx
  801d0f:	74 2c                	je     801d3d <ipc_recv+0x61>
  801d11:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d17:	eb 24                	jmp    801d3d <ipc_recv+0x61>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801d19:	85 f6                	test   %esi,%esi
  801d1b:	74 0a                	je     801d27 <ipc_recv+0x4b>
  801d1d:	a1 04 40 80 00       	mov    0x804004,%eax
  801d22:	8b 40 74             	mov    0x74(%eax),%eax
  801d25:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801d27:	85 db                	test   %ebx,%ebx
  801d29:	74 0a                	je     801d35 <ipc_recv+0x59>
  801d2b:	a1 04 40 80 00       	mov    0x804004,%eax
  801d30:	8b 40 78             	mov    0x78(%eax),%eax
  801d33:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  801d35:	a1 04 40 80 00       	mov    0x804004,%eax
  801d3a:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d56:	eb 25                	jmp    801d7d <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801d58:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d5b:	74 20                	je     801d7d <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801d5d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801d61:	c7 44 24 08 00 25 80 	movl   $0x802500,0x8(%esp)
  801d68:	00 
  801d69:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801d70:	00 
  801d71:	c7 04 24 0c 25 80 00 	movl   $0x80250c,(%esp)
  801d78:	e8 29 f4 ff ff       	call   8011a6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d7f:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801d84:	0f 45 c3             	cmovne %ebx,%eax
  801d87:	8b 55 14             	mov    0x14(%ebp),%edx
  801d8a:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801d8e:	89 44 24 08          	mov    %eax,0x8(%esp)
  801d92:	89 74 24 04          	mov    %esi,0x4(%esp)
  801d96:	89 3c 24             	mov    %edi,(%esp)
  801d99:	e8 ec e5 ff ff       	call   80038a <sys_ipc_try_send>
  801d9e:	85 c0                	test   %eax,%eax
  801da0:	75 b6                	jne    801d58 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801db0:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801db5:	39 c8                	cmp    %ecx,%eax
  801db7:	74 17                	je     801dd0 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801db9:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801dbe:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801dc1:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801dc7:	8b 52 50             	mov    0x50(%edx),%edx
  801dca:	39 ca                	cmp    %ecx,%edx
  801dcc:	75 14                	jne    801de2 <ipc_find_env+0x38>
  801dce:	eb 05                	jmp    801dd5 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801dd5:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801dd8:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801ddd:	8b 40 40             	mov    0x40(%eax),%eax
  801de0:	eb 0e                	jmp    801df0 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801de5:	3d 00 04 00 00       	cmp    $0x400,%eax
  801dea:	75 d2                	jne    801dbe <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801dec:	66 b8 00 00          	mov    $0x0,%ax
}
  801df0:	5d                   	pop    %ebp
  801df1:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801dfa:	c1 e8 16             	shr    $0x16,%eax
  801dfd:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e09:	f6 c1 01             	test   $0x1,%cl
  801e0c:	74 1d                	je     801e2b <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e0e:	c1 ea 0c             	shr    $0xc,%edx
  801e11:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e18:	f6 c2 01             	test   $0x1,%dl
  801e1b:	74 0e                	je     801e2b <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e1d:	c1 ea 0c             	shr    $0xc,%edx
  801e20:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e27:	ef 
  801e28:	0f b7 c0             	movzwl %ax,%eax
}
  801e2b:	5d                   	pop    %ebp
  801e2c:	c3                   	ret    
