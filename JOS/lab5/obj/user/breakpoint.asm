...
sys_env_destroy(envid_t envid)
{
  ...
  800134:	00 
  800135:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  80013c:	00 
  80013d:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800144:	00 
  800145:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80014c:	e8 85 10 00 00       	call   8011d6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001c6:	00 
  8001c7:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8001ce:	00 
  8001cf:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001d6:	00 
  8001d7:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8001de:	e8 f3 0f 00 00       	call   8011d6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800219:	00 
  80021a:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800221:	00 
  800222:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800229:	00 
  80022a:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800231:	e8 a0 0f 00 00       	call   8011d6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80026c:	00 
  80026d:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800274:	00 
  800275:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80027c:	00 
  80027d:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800284:	e8 4d 0f 00 00       	call   8011d6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002bf:	00 
  8002c0:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8002c7:	00 
  8002c8:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002cf:	00 
  8002d0:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8002d7:	e8 fa 0e 00 00       	call   8011d6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800312:	00 
  800313:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  80031a:	00 
  80031b:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800322:	00 
  800323:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80032a:	e8 a7 0e 00 00       	call   8011d6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800365:	00 
  800366:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  80036d:	00 
  80036e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800375:	00 
  800376:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80037d:	e8 54 0e 00 00       	call   8011d6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003da:	00 
  8003db:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8003e2:	00 
  8003e3:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003ea:	00 
  8003eb:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8003f2:	e8 df 0d 00 00       	call   8011d6 <_panic>
...
devpipe_close(struct Fd *fd)
{
  ...
  800cd8:	e8 61 f5 ff ff       	call   80023e <sys_page_unmap>
  ...
  800cf0:	e8 49 f5 ff ff       	call   80023e <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d92:	75 54                	jne    800de8 <devpipe_write+0x84>
			...
			sys_yield();
  800d94:	e8 df f3 ff ff       	call   800178 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e27:	75 43                	jne    800e6c <devpipe_read+0x77>
			...
			sys_yield();
  800e29:	e8 4a f3 ff ff       	call   800178 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800eac:	e8 e6 f2 ff ff       	call   800197 <sys_page_alloc>
  ...
  800ee6:	e8 ac f2 ff ff       	call   800197 <sys_page_alloc>
  ...
  800f15:	e8 7d f2 ff ff       	call   800197 <sys_page_alloc>
  ...
  800f4e:	e8 98 f2 ff ff       	call   8001eb <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801096:	e8 2f f0 ff ff       	call   8000ca <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010c9:	eb 28                	jmp    8010f3 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010cb:	e8 a8 f0 ff ff       	call   800178 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010d0:	e8 13 f0 ff ff       	call   8000e8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80110f:	e8 b6 ef ff ff       	call   8000ca <sys_cputs>
}
  801114:	c9                   	leave  
  801115:	c3                   	ret    
...
opencons(void)
{
  ...
  8011a8:	e8 ea ef ff ff       	call   800197 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011e7:	e8 6d ef ff ff       	call   800159 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801259:	e8 6c ee ff ff       	call   8000ca <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012c2:	e8 03 ee ff ff       	call   8000ca <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d2a:	e8 7e e6 ff ff       	call   8003ad <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dc9:	e8 bc e5 ff ff       	call   80038a <sys_ipc_try_send>
