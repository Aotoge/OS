	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027e:	0f be 80 48 21 80 00 	movsbl 0x802148(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039c:	ff 24 85 80 22 80 00 	jmp    *0x802280(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80047e:	c7 44 24 08 1f 25 80 	movl   $0x80251f,0x8(%esp)
  800485:	00 
  ...
  8004ad:	ba 59 21 80 00       	mov    $0x802159,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c26:	00 
  800c27:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800c2e:	00 
  800c2f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800c36:	00 
  800c37:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800db1:	00 
  800db2:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800db9:	00 
  800dba:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800dc1:	00 
  800dc2:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e04:	00 
  800e05:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800e0c:	00 
  800e0d:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e14:	00 
  800e15:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e57:	00 
  800e58:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800e5f:	00 
  800e60:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e67:	00 
  800e68:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ecc:	00 
  800ecd:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800ed4:	00 
  800ed5:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800edc:	00 
  800edd:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801045:	c7 04 24 6c 24 80 00 	movl   $0x80246c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80129b:	c7 04 24 ad 24 80 00 	movl   $0x8024ad,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801383:	c7 04 24 c9 24 80 00 	movl   $0x8024c9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80143c:	c7 04 24 8c 24 80 00 	movl   $0x80248c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  80156f:	c7 04 24 e6 24 80 00 	movl   $0x8024e6,(%esp)
  ...
  801597:	e8 f8 07 00 00       	call   801d94 <ipc_send>
	cprintf("ipc_send\n");
  80159c:	c7 04 24 fc 24 80 00 	movl   $0x8024fc,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801679:	c7 44 24 0c 06 25 80 	movl   $0x802506,0xc(%esp)
  801680:	00 
  801681:	c7 44 24 08 0d 25 80 	movl   $0x80250d,0x8(%esp)
  801688:	00 
  801689:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801690:	00 
  801691:	c7 04 24 22 25 80 00 	movl   $0x802522,(%esp)
  801698:	e8 39 06 00 00       	call   801cd6 <_panic>
	assert(r <= PGSIZE);
  80169d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016a2:	7e 24                	jle    8016c8 <devfile_read+0x84>
  8016a4:	c7 44 24 0c 2d 25 80 	movl   $0x80252d,0xc(%esp)
  8016ab:	00 
  8016ac:	c7 44 24 08 0d 25 80 	movl   $0x80250d,0x8(%esp)
  8016b3:	00 
  8016b4:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  8016bb:	00 
  8016bc:	c7 04 24 22 25 80 00 	movl   $0x802522,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801788:	c7 44 24 04 39 25 80 	movl   $0x802539,0x4(%esp)
  80178f:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80184e:	c7 04 24 40 25 80 00 	movl   $0x802540,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b30:	c7 44 24 04 58 25 80 	movl   $0x802558,0x4(%esp)
  801b37:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801d02:	c7 04 24 64 25 80 00 	movl   $0x802564,(%esp)
  ...
  801d18:	e8 06 e4 ff ff       	call   800123 <vcprintf>
	cprintf("\n");
  801d1d:	c7 04 24 3c 21 80 00 	movl   $0x80213c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801db1:	c7 44 24 08 88 25 80 	movl   $0x802588,0x8(%esp)
  801db8:	00 
  801db9:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801dc0:	00 
  801dc1:	c7 04 24 94 25 80 00 	movl   $0x802594,(%esp)
