	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027e:	0f be 80 08 21 80 00 	movsbl 0x802108(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039c:	ff 24 85 40 22 80 00 	jmp    *0x802240(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80047e:	c7 44 24 08 bf 24 80 	movl   $0x8024bf,0x8(%esp)
  800485:	00 
  ...
  8004ad:	ba 19 21 80 00       	mov    $0x802119,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c26:	00 
  800c27:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800c2e:	00 
  800c2f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800c36:	00 
  800c37:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800db1:	00 
  800db2:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800db9:	00 
  800dba:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800dc1:	00 
  800dc2:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e04:	00 
  800e05:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800e0c:	00 
  800e0d:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e14:	00 
  800e15:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e57:	00 
  800e58:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800e5f:	00 
  800e60:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e67:	00 
  800e68:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ecc:	00 
  800ecd:	c7 44 24 08 ff 23 80 	movl   $0x8023ff,0x8(%esp)
  800ed4:	00 
  800ed5:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800edc:	00 
  800edd:	c7 04 24 1c 24 80 00 	movl   $0x80241c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801045:	c7 04 24 2c 24 80 00 	movl   $0x80242c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80129b:	c7 04 24 6d 24 80 00 	movl   $0x80246d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801383:	c7 04 24 89 24 80 00 	movl   $0x802489,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80143c:	c7 04 24 4c 24 80 00 	movl   $0x80244c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  80154b:	e8 7c 08 00 00       	call   801dcc <ipc_find_env>
  ...
  801571:	e8 f0 07 00 00       	call   801d66 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801647:	c7 44 24 0c a6 24 80 	movl   $0x8024a6,0xc(%esp)
  80164e:	00 
  80164f:	c7 44 24 08 ad 24 80 	movl   $0x8024ad,0x8(%esp)
  801656:	00 
  801657:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  80165e:	00 
  80165f:	c7 04 24 c2 24 80 00 	movl   $0x8024c2,(%esp)
  801666:	e8 3b 06 00 00       	call   801ca6 <_panic>
	assert(r <= PGSIZE);
  80166b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801670:	7e 24                	jle    801696 <devfile_read+0x84>
  801672:	c7 44 24 0c cd 24 80 	movl   $0x8024cd,0xc(%esp)
  801679:	00 
  80167a:	c7 44 24 08 ad 24 80 	movl   $0x8024ad,0x8(%esp)
  801681:	00 
  801682:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801689:	00 
  80168a:	c7 04 24 c2 24 80 00 	movl   $0x8024c2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801758:	c7 44 24 04 d9 24 80 	movl   $0x8024d9,0x4(%esp)
  80175f:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80181e:	c7 04 24 e0 24 80 00 	movl   $0x8024e0,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b00:	c7 44 24 04 f8 24 80 	movl   $0x8024f8,0x4(%esp)
  801b07:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801cd2:	c7 04 24 04 25 80 00 	movl   $0x802504,(%esp)
  ...
  801ce8:	e8 36 e4 ff ff       	call   800123 <vcprintf>
	cprintf("\n");
  801ced:	c7 04 24 fc 20 80 00 	movl   $0x8020fc,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d1c:	e8 7e f1 ff ff       	call   800e9f <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d83:	c7 44 24 08 28 25 80 	movl   $0x802528,0x8(%esp)
  801d8a:	00 
  801d8b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801d92:	00 
  801d93:	c7 04 24 34 25 80 00 	movl   $0x802534,(%esp)
  801d9a:	e8 07 ff ff ff       	call   801ca6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dbb:	e8 bc f0 ff ff       	call   800e7c <sys_ipc_try_send>
