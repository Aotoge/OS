...
fsipc(unsigned type, void *dstva)
{
  ...
  80171b:	e8 64 09 00 00       	call   802084 <ipc_find_env>
  ...
  801741:	e8 d8 08 00 00       	call   80201e <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801826:	00 
  801827:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  80182e:	00 
  ...
  801851:	00 
  801852:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801859:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801fd4:	e8 96 f0 ff ff       	call   80106f <sys_ipc_recv>
	if (err_code < 0) {
  801fd9:	85 c0                	test   %eax,%eax
  801fdb:	79 16                	jns    801ff3 <ipc_recv+0x3d>
		if (from_env_store) *from_env_store = 0;
  801fdd:	85 f6                	test   %esi,%esi
  801fdf:	74 06                	je     801fe7 <ipc_recv+0x31>
  801fe1:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801fe7:	85 db                	test   %ebx,%ebx
  801fe9:	74 2c                	je     802017 <ipc_recv+0x61>
  801feb:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801ff1:	eb 24                	jmp    802017 <ipc_recv+0x61>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801ff3:	85 f6                	test   %esi,%esi
  801ff5:	74 0a                	je     802001 <ipc_recv+0x4b>
  801ff7:	a1 08 40 80 00       	mov    0x804008,%eax
  801ffc:	8b 40 74             	mov    0x74(%eax),%eax
  801fff:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  802001:	85 db                	test   %ebx,%ebx
  802003:	74 0a                	je     80200f <ipc_recv+0x59>
  802005:	a1 08 40 80 00       	mov    0x804008,%eax
  80200a:	8b 40 78             	mov    0x78(%eax),%eax
  80200d:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  80200f:	a1 08 40 80 00       	mov    0x804008,%eax
  802014:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80202a:	8b 75 0c             	mov    0xc(%ebp),%esi
  80202d:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int err_code;
	while ((err_code = sys_ipc_try_send(to_env, val, pg == NULL ? (void*)UTOP : pg, perm))) {
  802030:	eb 25                	jmp    802057 <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  802032:	83 f8 f9             	cmp    $0xfffffff9,%eax
  802035:	74 20                	je     802057 <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  802037:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80203b:	c7 44 24 08 27 28 80 	movl   $0x802827,0x8(%esp)
  802042:	00 
  802043:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  80204a:	00 
  80204b:	c7 04 24 33 28 80 00 	movl   $0x802833,(%esp)
  802052:	e8 06 e2 ff ff       	call   80025d <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80205e:	0f 45 c3             	cmovne %ebx,%eax
  802061:	8b 55 14             	mov    0x14(%ebp),%edx
  802064:	89 54 24 0c          	mov    %edx,0xc(%esp)
  802068:	89 44 24 08          	mov    %eax,0x8(%esp)
  80206c:	89 74 24 04          	mov    %esi,0x4(%esp)
  802070:	89 3c 24             	mov    %edi,(%esp)
  802073:	e8 d4 ef ff ff       	call   80104c <sys_ipc_try_send>
  802078:	85 c0                	test   %eax,%eax
  80207a:	75 b6                	jne    802032 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  80208a:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  80208f:	39 c8                	cmp    %ecx,%eax
  802091:	74 17                	je     8020aa <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802093:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  802098:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80209b:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8020a1:	8b 52 50             	mov    0x50(%edx),%edx
  8020a4:	39 ca                	cmp    %ecx,%edx
  8020a6:	75 14                	jne    8020bc <ipc_find_env+0x38>
  8020a8:	eb 05                	jmp    8020af <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8020b2:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8020b7:	8b 40 40             	mov    0x40(%eax),%eax
  8020ba:	eb 0e                	jmp    8020ca <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8020c4:	75 d2                	jne    802098 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
