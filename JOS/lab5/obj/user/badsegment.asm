...
sys_env_destroy(envid_t envid)
{
  ...
  800139:	00 
  80013a:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800141:	00 
  800142:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800149:	00 
  80014a:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800151:	e8 90 10 00 00       	call   8011e6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001cb:	00 
  8001cc:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8001d3:	00 
  8001d4:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001db:	00 
  8001dc:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8001e3:	e8 fe 0f 00 00       	call   8011e6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80021e:	00 
  80021f:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800226:	00 
  800227:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80022e:	00 
  80022f:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800236:	e8 ab 0f 00 00       	call   8011e6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800271:	00 
  800272:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800279:	00 
  80027a:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800281:	00 
  800282:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800289:	e8 58 0f 00 00       	call   8011e6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002c4:	00 
  8002c5:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8002cc:	00 
  8002cd:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002d4:	00 
  8002d5:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8002dc:	e8 05 0f 00 00       	call   8011e6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800317:	00 
  800318:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  80031f:	00 
  800320:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800327:	00 
  800328:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80032f:	e8 b2 0e 00 00       	call   8011e6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80036a:	00 
  80036b:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800372:	00 
  800373:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80037a:	00 
  80037b:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800382:	e8 5f 0e 00 00       	call   8011e6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003df:	00 
  8003e0:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8003e7:	00 
  8003e8:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003ef:	00 
  8003f0:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8003f7:	e8 ea 0d 00 00       	call   8011e6 <_panic>
...
devpipe_close(struct Fd *fd)
{
  ...
  800ce8:	e8 56 f5 ff ff       	call   800243 <sys_page_unmap>
  ...
  800d00:	e8 3e f5 ff ff       	call   800243 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800da2:	75 54                	jne    800df8 <devpipe_write+0x84>
			...
			sys_yield();
  800da4:	e8 d4 f3 ff ff       	call   80017d <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e37:	75 43                	jne    800e7c <devpipe_read+0x77>
			...
			sys_yield();
  800e39:	e8 3f f3 ff ff       	call   80017d <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800ebc:	e8 db f2 ff ff       	call   80019c <sys_page_alloc>
  ...
  800ef6:	e8 a1 f2 ff ff       	call   80019c <sys_page_alloc>
  ...
  800f25:	e8 72 f2 ff ff       	call   80019c <sys_page_alloc>
  ...
  800f5e:	e8 8d f2 ff ff       	call   8001f0 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8010a6:	e8 24 f0 ff ff       	call   8000cf <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010d9:	eb 28                	jmp    801103 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010db:	e8 9d f0 ff ff       	call   80017d <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010e0:	e8 08 f0 ff ff       	call   8000ed <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80111f:	e8 ab ef ff ff       	call   8000cf <sys_cputs>
}
  801124:	c9                   	leave  
  801125:	c3                   	ret    
...
opencons(void)
{
  ...
  8011b8:	e8 df ef ff ff       	call   80019c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011f7:	e8 62 ef ff ff       	call   80015e <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801269:	e8 61 ee ff ff       	call   8000cf <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012d2:	e8 f8 ed ff ff       	call   8000cf <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d3a:	e8 73 e6 ff ff       	call   8003b2 <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dd9:	e8 b1 e5 ff ff       	call   80038f <sys_ipc_try_send>
