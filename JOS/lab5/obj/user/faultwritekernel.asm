...
sys_env_destroy(envid_t envid)
{
  ...
  80013d:	00 
  80013e:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800145:	00 
  800146:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80014d:	00 
  80014e:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800155:	e8 5c 10 00 00       	call   8011b6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001cf:	00 
  8001d0:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8001d7:	00 
  8001d8:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8001df:	00 
  8001e0:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8001e7:	e8 ca 0f 00 00       	call   8011b6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800222:	00 
  800223:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  80022a:	00 
  80022b:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800232:	00 
  800233:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  80023a:	e8 77 0f 00 00       	call   8011b6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800275:	00 
  800276:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  80027d:	00 
  80027e:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800285:	00 
  800286:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  80028d:	e8 24 0f 00 00       	call   8011b6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002c8:	00 
  8002c9:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8002d0:	00 
  8002d1:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8002d8:	00 
  8002d9:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8002e0:	e8 d1 0e 00 00       	call   8011b6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80031b:	00 
  80031c:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800323:	00 
  800324:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80032b:	00 
  80032c:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800333:	e8 7e 0e 00 00       	call   8011b6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80036e:	00 
  80036f:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800376:	00 
  800377:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  80037e:	00 
  80037f:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800386:	e8 2b 0e 00 00       	call   8011b6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003e3:	00 
  8003e4:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8003eb:	00 
  8003ec:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8003f3:	00 
  8003f4:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8003fb:	e8 b6 0d 00 00       	call   8011b6 <_panic>
...
devpipe_close(struct Fd *fd)
{
  ...
  800cb8:	e8 8a f5 ff ff       	call   800247 <sys_page_unmap>
  ...
  800cd0:	e8 72 f5 ff ff       	call   800247 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d72:	75 54                	jne    800dc8 <devpipe_write+0x84>
			...
			sys_yield();
  800d74:	e8 08 f4 ff ff       	call   800181 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800e07:	75 43                	jne    800e4c <devpipe_read+0x77>
			...
			sys_yield();
  800e09:	e8 73 f3 ff ff       	call   800181 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e8c:	e8 0f f3 ff ff       	call   8001a0 <sys_page_alloc>
  ...
  800ec6:	e8 d5 f2 ff ff       	call   8001a0 <sys_page_alloc>
  ...
  800ef5:	e8 a6 f2 ff ff       	call   8001a0 <sys_page_alloc>
  ...
  800f2e:	e8 c1 f2 ff ff       	call   8001f4 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801076:	e8 58 f0 ff ff       	call   8000d3 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8010a9:	eb 28                	jmp    8010d3 <devcons_read+0x3b>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8010ab:	e8 d1 f0 ff ff       	call   800181 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8010b0:	e8 3c f0 ff ff       	call   8000f1 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8010ef:	e8 df ef ff ff       	call   8000d3 <sys_cputs>
}
  8010f4:	c9                   	leave  
  8010f5:	c3                   	ret    
...
opencons(void)
{
  ...
  801188:	e8 13 f0 ff ff       	call   8001a0 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011c7:	e8 96 ef ff ff       	call   800162 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801239:	e8 95 ee ff ff       	call   8000d3 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8012a2:	e8 2c ee ff ff       	call   8000d3 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d0c:	e8 a5 e6 ff ff       	call   8003b6 <sys_ipc_recv>
	if (err_code < 0) {
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dab:	e8 e3 e5 ff ff       	call   800393 <sys_ipc_try_send>
