...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d4f:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  801d5d:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d93:	c7 44 24 08 48 25 80 	movl   $0x802548,0x8(%esp)
  801d9a:	00 
  801d9b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801da2:	00 
  801da3:	c7 04 24 54 25 80 00 	movl   $0x802554,(%esp)
