...
fsipc(unsigned type, void *dstva)
{
  ...
  8016bb:	e8 64 09 00 00       	call   802024 <ipc_find_env>
  ...
  8016e1:	e8 d8 08 00 00       	call   801fbe <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8017c6:	00 
  8017c7:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  8017ce:	00 
  ...
  8017f1:	00 
  8017f2:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  8017f9:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f74:	e8 96 f0 ff ff       	call   80100f <sys_ipc_recv>
	if (err_code < 0) {
  ...
  801f97:	a1 20 60 80 00       	mov    0x806020,%eax
  ...
  801fa5:	a1 20 60 80 00       	mov    0x806020,%eax
  801faa:	8b 40 78             	mov    0x78(%eax),%eax
  801fad:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  801faf:	a1 20 60 80 00       	mov    0x806020,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801fdb:	c7 44 24 08 c7 27 80 	movl   $0x8027c7,0x8(%esp)
  801fe2:	00 
  801fe3:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801fea:	00 
  801feb:	c7 04 24 d3 27 80 00 	movl   $0x8027d3,(%esp)
  801ff2:	e8 05 e2 ff ff       	call   8001fc <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802013:	e8 d4 ef ff ff       	call   800fec <sys_ipc_try_send>
