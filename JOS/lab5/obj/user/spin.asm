...
fsipc(unsigned type, void *dstva)
{
  ...
  8018fb:	e8 36 09 00 00       	call   802236 <ipc_find_env>
  ...
  801921:	e8 aa 08 00 00       	call   8021d0 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801a06:	00 
  801a07:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801a0e:	00 
  ...
  801a31:	00 
  801a32:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801a39:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802177:	83 f8 01             	cmp    $0x1,%eax
  80217a:	19 c0                	sbb    %eax,%eax
  80217c:	f7 d0                	not    %eax
  80217e:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  802183:	89 04 24             	mov    %eax,(%esp)
  802186:	e8 84 ed ff ff       	call   800f0f <sys_ipc_recv>
	if (err_code < 0) {
  80218b:	85 c0                	test   %eax,%eax
  80218d:	79 16                	jns    8021a5 <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  80218f:	85 f6                	test   %esi,%esi
  802191:	74 06                	je     802199 <ipc_recv+0x33>
  802193:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  802199:	85 db                	test   %ebx,%ebx
  80219b:	74 2c                	je     8021c9 <ipc_recv+0x63>
  80219d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8021a3:	eb 24                	jmp    8021c9 <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  8021a5:	85 f6                	test   %esi,%esi
  8021a7:	74 0a                	je     8021b3 <ipc_recv+0x4d>
  ...
  8021b5:	74 0a                	je     8021c1 <ipc_recv+0x5b>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8021dc:	8b 75 0c             	mov    0xc(%ebp),%esi
  8021df:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int err_code;
	while ((err_code = sys_ipc_try_send(to_env, val, pg == NULL ? (void*)UTOP : pg, perm))) {
  8021e2:	eb 25                	jmp    802209 <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  8021e4:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8021e7:	74 20                	je     802209 <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  8021e9:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8021ed:	c7 44 24 08 8a 2b 80 	movl   $0x802b8a,0x8(%esp)
  8021f4:	00 
  8021f5:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  8021fc:	00 
  8021fd:	c7 04 24 96 2b 80 00 	movl   $0x802b96,(%esp)
  802204:	e8 4d fe ff ff       	call   802056 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802210:	0f 45 c3             	cmovne %ebx,%eax
  802213:	8b 55 14             	mov    0x14(%ebp),%edx
  802216:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80221a:	89 44 24 08          	mov    %eax,0x8(%esp)
  80221e:	89 74 24 04          	mov    %esi,0x4(%esp)
  802222:	89 3c 24             	mov    %edi,(%esp)
  802225:	e8 c2 ec ff ff       	call   800eec <sys_ipc_try_send>
  80222a:	85 c0                	test   %eax,%eax
  80222c:	75 b6                	jne    8021e4 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  80223c:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  802241:	39 c8                	cmp    %ecx,%eax
  802243:	74 17                	je     80225c <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802245:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  80224a:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80224d:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  802253:	8b 52 50             	mov    0x50(%edx),%edx
  802256:	39 ca                	cmp    %ecx,%edx
  802258:	75 14                	jne    80226e <ipc_find_env+0x38>
  80225a:	eb 05                	jmp    802261 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802261:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802264:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  802269:	8b 40 40             	mov    0x40(%eax),%eax
  80226c:	eb 0e                	jmp    80227c <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  80226e:	83 c0 01             	add    $0x1,%eax
  802271:	3d 00 04 00 00       	cmp    $0x400,%eax
  802276:	75 d2                	jne    80224a <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  802278:	66 b8 00 00          	mov    $0x0,%ax
}
  80227c:	5d                   	pop    %ebp
  80227d:	c3                   	ret    
...
pageref(void *v)
{
  ...
  802286:	c1 e8 16             	shr    $0x16,%eax
  802289:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  802295:	f6 c1 01             	test   $0x1,%cl
  802298:	74 1d                	je     8022b7 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  80229a:	c1 ea 0c             	shr    $0xc,%edx
  80229d:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  8022a4:	f6 c2 01             	test   $0x1,%dl
  8022a7:	74 0e                	je     8022b7 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  8022a9:	c1 ea 0c             	shr    $0xc,%edx
  8022ac:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  8022b3:	ef 
  8022b4:	0f b7 c0             	movzwl %ax,%eax
}
  8022b7:	5d                   	pop    %ebp
  8022b8:	c3                   	ret    
