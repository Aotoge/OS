...
fsipc(unsigned type, void *dstva)
{
  ...
  800f5b:	e8 16 0f 00 00       	call   801e76 <ipc_find_env>
  ...
  800f81:	e8 8a 0e 00 00       	call   801e10 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801066:	00 
  801067:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  80106e:	00 
  ...
  801091:	00 
  801092:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  801099:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801dbb:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801dc0:	0f 44 c2             	cmove  %edx,%eax
  801dc3:	89 04 24             	mov    %eax,(%esp)
  801dc6:	e8 e4 ea ff ff       	call   8008af <sys_ipc_recv>
	if (err_code < 0) {
  801dcb:	85 c0                	test   %eax,%eax
  801dcd:	79 16                	jns    801de5 <ipc_recv+0x3d>
		if (from_env_store) *from_env_store = 0;
  801dcf:	85 f6                	test   %esi,%esi
  801dd1:	74 06                	je     801dd9 <ipc_recv+0x31>
  801dd3:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801dd9:	85 db                	test   %ebx,%ebx
  801ddb:	74 2c                	je     801e09 <ipc_recv+0x61>
  801ddd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801de3:	eb 24                	jmp    801e09 <ipc_recv+0x61>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801de5:	85 f6                	test   %esi,%esi
  801de7:	74 0a                	je     801df3 <ipc_recv+0x4b>
  801de9:	a1 04 40 80 00       	mov    0x804004,%eax
  801dee:	8b 40 74             	mov    0x74(%eax),%eax
  801df1:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801df3:	85 db                	test   %ebx,%ebx
  801df5:	74 0a                	je     801e01 <ipc_recv+0x59>
  801df7:	a1 04 40 80 00       	mov    0x804004,%eax
  801dfc:	8b 40 78             	mov    0x78(%eax),%eax
  801dff:	89 03                	mov    %eax,(%ebx)
	}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e22:	eb 25                	jmp    801e49 <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801e24:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e27:	74 20                	je     801e49 <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801e29:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e2d:	c7 44 24 08 e0 25 80 	movl   $0x8025e0,0x8(%esp)
  801e34:	00 
  801e35:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801e3c:	00 
  801e3d:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  801e44:	e8 6d f8 ff ff       	call   8016b6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e50:	0f 45 c3             	cmovne %ebx,%eax
  801e53:	8b 55 14             	mov    0x14(%ebp),%edx
  801e56:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801e5a:	89 44 24 08          	mov    %eax,0x8(%esp)
  801e5e:	89 74 24 04          	mov    %esi,0x4(%esp)
  801e62:	89 3c 24             	mov    %edi,(%esp)
  801e65:	e8 22 ea ff ff       	call   80088c <sys_ipc_try_send>
  801e6a:	85 c0                	test   %eax,%eax
  801e6c:	75 b6                	jne    801e24 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
pageref(void *v)
{
  ...
  801ec9:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801ed5:	f6 c1 01             	test   $0x1,%cl
  801ed8:	74 1d                	je     801ef7 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  801ee7:	74 0e                	je     801ef7 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801ee9:	c1 ea 0c             	shr    $0xc,%edx
  801eec:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801ef3:	ef 
  801ef4:	0f b7 c0             	movzwl %ax,%eax
}
  801ef7:	5d                   	pop    %ebp
  801ef8:	c3                   	ret    
