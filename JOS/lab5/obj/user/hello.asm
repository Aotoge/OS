...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 00 21 80 00 	movl   $0x802100,(%esp)
  ...
  800051:	c7 04 24 0e 21 80 00 	movl   $0x80210e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028e:	0f be 80 2f 21 80 00 	movsbl 0x80212f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003ac:	ff 24 85 80 22 80 00 	jmp    *0x802280(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80048e:	c7 44 24 08 ff 24 80 	movl   $0x8024ff,0x8(%esp)
  800495:	00 
  ...
  8004bd:	ba 40 21 80 00       	mov    $0x802140,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c36:	00 
  800c37:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800c3e:	00 
  800c3f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800c46:	00 
  800c47:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc8:	00 
  800cc9:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d1b:	00 
  800d1c:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800d23:	00 
  800d24:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d2b:	00 
  800d2c:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d6e:	00 
  800d6f:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800d76:	00 
  800d77:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800d7e:	00 
  800d7f:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dc1:	00 
  800dc2:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800dc9:	00 
  800dca:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800dd1:	00 
  800dd2:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e14:	00 
  800e15:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800e1c:	00 
  800e1d:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e24:	00 
  800e25:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e67:	00 
  800e68:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800e6f:	00 
  800e70:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800e77:	00 
  800e78:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800edc:	00 
  800edd:	c7 44 24 08 3f 24 80 	movl   $0x80243f,0x8(%esp)
  800ee4:	00 
  800ee5:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800eec:	00 
  800eed:	c7 04 24 5c 24 80 00 	movl   $0x80245c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801055:	c7 04 24 6c 24 80 00 	movl   $0x80246c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8012ab:	c7 04 24 ad 24 80 00 	movl   $0x8024ad,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801393:	c7 04 24 c9 24 80 00 	movl   $0x8024c9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80144c:	c7 04 24 8c 24 80 00 	movl   $0x80248c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  80155b:	e8 7c 08 00 00       	call   801ddc <ipc_find_env>
  ...
  801581:	e8 f0 07 00 00       	call   801d76 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801657:	c7 44 24 0c e6 24 80 	movl   $0x8024e6,0xc(%esp)
  80165e:	00 
  80165f:	c7 44 24 08 ed 24 80 	movl   $0x8024ed,0x8(%esp)
  801666:	00 
  801667:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  80166e:	00 
  80166f:	c7 04 24 02 25 80 00 	movl   $0x802502,(%esp)
  801676:	e8 3b 06 00 00       	call   801cb6 <_panic>
	assert(r <= PGSIZE);
  80167b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801680:	7e 24                	jle    8016a6 <devfile_read+0x84>
  801682:	c7 44 24 0c 0d 25 80 	movl   $0x80250d,0xc(%esp)
  801689:	00 
  80168a:	c7 44 24 08 ed 24 80 	movl   $0x8024ed,0x8(%esp)
  801691:	00 
  801692:	c7 44 24 04 7b 00 00 	movl   $0x7b,0x4(%esp)
  801699:	00 
  80169a:	c7 04 24 02 25 80 00 	movl   $0x802502,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801768:	c7 44 24 04 19 25 80 	movl   $0x802519,0x4(%esp)
  80176f:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80182e:	c7 04 24 20 25 80 00 	movl   $0x802520,(%esp)
  801835:	e8 59 e9 ff ff       	call   800193 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b10:	c7 44 24 04 38 25 80 	movl   $0x802538,0x4(%esp)
  801b17:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ce2:	c7 04 24 44 25 80 00 	movl   $0x802544,(%esp)
  801ce9:	e8 a5 e4 ff ff       	call   800193 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801cee:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801cf2:	8b 45 10             	mov    0x10(%ebp),%eax
  801cf5:	89 04 24             	mov    %eax,(%esp)
  801cf8:	e8 35 e4 ff ff       	call   800132 <vcprintf>
	cprintf("\n");
  801cfd:	c7 04 24 31 25 80 00 	movl   $0x802531,(%esp)
  801d04:	e8 8a e4 ff ff       	call   800193 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d22:	f7 d0                	not    %eax
  801d24:	25 00 00 c0 ee       	and    $0xeec00000,%eax
  801d29:	89 04 24             	mov    %eax,(%esp)
  801d2c:	e8 7e f1 ff ff       	call   800eaf <sys_ipc_recv>
	if (err_code < 0) {
  801d31:	85 c0                	test   %eax,%eax
  801d33:	79 16                	jns    801d4b <ipc_recv+0x3f>
		if (from_env_store) *from_env_store = 0;
  801d35:	85 f6                	test   %esi,%esi
  801d37:	74 06                	je     801d3f <ipc_recv+0x33>
  801d39:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  801d3f:	85 db                	test   %ebx,%ebx
  801d41:	74 2c                	je     801d6f <ipc_recv+0x63>
  801d43:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d49:	eb 24                	jmp    801d6f <ipc_recv+0x63>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  801d4b:	85 f6                	test   %esi,%esi
  801d4d:	74 0a                	je     801d59 <ipc_recv+0x4d>
  801d4f:	a1 04 40 80 00       	mov    0x804004,%eax
  801d54:	8b 40 74             	mov    0x74(%eax),%eax
  801d57:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  801d59:	85 db                	test   %ebx,%ebx
  801d5b:	74 0a                	je     801d67 <ipc_recv+0x5b>
  801d5d:	a1 04 40 80 00       	mov    0x804004,%eax
  801d62:	8b 40 78             	mov    0x78(%eax),%eax
  801d65:	89 03                	mov    %eax,(%ebx)
	}
	return err_code < 0 ? err_code : thisenv->env_ipc_value;
  801d67:	a1 04 40 80 00       	mov    0x804004,%eax
  801d6c:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d82:	8b 75 0c             	mov    0xc(%ebp),%esi
  801d85:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int err_code;
	while ((err_code = sys_ipc_try_send(to_env, val, pg == NULL ? (void*)UTOP : pg, perm))) {
  801d88:	eb 25                	jmp    801daf <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  801d8a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d8d:	74 20                	je     801daf <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  801d8f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801d93:	c7 44 24 08 68 25 80 	movl   $0x802568,0x8(%esp)
  801d9a:	00 
  801d9b:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  801da2:	00 
  801da3:	c7 04 24 74 25 80 00 	movl   $0x802574,(%esp)
  801daa:	e8 07 ff ff ff       	call   801cb6 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801db1:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801db6:	0f 45 c3             	cmovne %ebx,%eax
  801db9:	8b 55 14             	mov    0x14(%ebp),%edx
  801dbc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801dc0:	89 44 24 08          	mov    %eax,0x8(%esp)
  801dc4:	89 74 24 04          	mov    %esi,0x4(%esp)
  801dc8:	89 3c 24             	mov    %edi,(%esp)
  801dcb:	e8 bc f0 ff ff       	call   800e8c <sys_ipc_try_send>
  801dd0:	85 c0                	test   %eax,%eax
  801dd2:	75 b6                	jne    801d8a <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801de2:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801de7:	39 c8                	cmp    %ecx,%eax
  801de9:	74 17                	je     801e02 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801deb:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801df0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801df3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801df9:	8b 52 50             	mov    0x50(%edx),%edx
  801dfc:	39 ca                	cmp    %ecx,%edx
  801dfe:	75 14                	jne    801e14 <ipc_find_env+0x38>
  801e00:	eb 05                	jmp    801e07 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e0a:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801e0f:	8b 40 40             	mov    0x40(%eax),%eax
  801e12:	eb 0e                	jmp    801e22 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801e1c:	75 d2                	jne    801df0 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801e1e:	66 b8 00 00          	mov    $0x0,%ax
}
  801e22:	5d                   	pop    %ebp
  801e23:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e2c:	c1 e8 16             	shr    $0x16,%eax
  801e2f:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e3b:	f6 c1 01             	test   $0x1,%cl
  801e3e:	74 1d                	je     801e5d <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e40:	c1 ea 0c             	shr    $0xc,%edx
  801e43:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e4a:	f6 c2 01             	test   $0x1,%dl
  801e4d:	74 0e                	je     801e5d <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e4f:	c1 ea 0c             	shr    $0xc,%edx
  801e52:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e59:	ef 
  801e5a:	0f b7 c0             	movzwl %ax,%eax
}
  801e5d:	5d                   	pop    %ebp
  801e5e:	c3                   	ret    
  801e5f:	90                   	nop
