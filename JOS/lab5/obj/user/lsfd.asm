...
fsipc(unsigned type, void *dstva)
{
  ...
  80177b:	e8 ba 09 00 00       	call   80213a <ipc_find_env>
  ...
  8017a1:	e8 2e 09 00 00       	call   8020d4 <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801886:	00 
  801887:	c7 44 24 04 79 00 00 	movl   $0x79,0x4(%esp)
  80188e:	00 
  ...
  8018b1:	00 
  8018b2:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  8018b9:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80208a:	e8 f0 ee ff ff       	call   800f7f <sys_ipc_recv>
	if (err_code < 0) {
  80208f:	85 c0                	test   %eax,%eax
  802091:	79 16                	jns    8020a9 <ipc_recv+0x3d>
		if (from_env_store) *from_env_store = 0;
  802093:	85 f6                	test   %esi,%esi
  802095:	74 06                	je     80209d <ipc_recv+0x31>
  802097:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store) *perm_store = 0;
  80209d:	85 db                	test   %ebx,%ebx
  80209f:	74 2c                	je     8020cd <ipc_recv+0x61>
  8020a1:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8020a7:	eb 24                	jmp    8020cd <ipc_recv+0x61>
	} else {
		if (from_env_store) *from_env_store = thisenv->env_ipc_from;
  8020a9:	85 f6                	test   %esi,%esi
  8020ab:	74 0a                	je     8020b7 <ipc_recv+0x4b>
  8020ad:	a1 04 40 80 00       	mov    0x804004,%eax
  8020b2:	8b 40 74             	mov    0x74(%eax),%eax
  8020b5:	89 06                	mov    %eax,(%esi)
		if (perm_store) *perm_store = thisenv->env_ipc_perm;
  8020b7:	85 db                	test   %ebx,%ebx
  8020b9:	74 0a                	je     8020c5 <ipc_recv+0x59>
  8020bb:	a1 04 40 80 00       	mov    0x804004,%eax
  8020c0:	8b 40 78             	mov    0x78(%eax),%eax
  8020c3:	89 03                	mov    %eax,(%ebx)
	}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020e6:	eb 25                	jmp    80210d <ipc_send+0x39>
		if (err_code != -E_IPC_NOT_RECV) {
  8020e8:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8020eb:	74 20                	je     80210d <ipc_send+0x39>
			panic("ipc_send:%e", err_code);
  8020ed:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8020f1:	c7 44 24 08 c8 28 80 	movl   $0x8028c8,0x8(%esp)
  8020f8:	00 
  8020f9:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  802100:	00 
  802101:	c7 04 24 d4 28 80 00 	movl   $0x8028d4,(%esp)
  802108:	e8 09 ff ff ff       	call   802016 <_panic>
//   as meaning "no page".  (Zero is not the right value.)
void
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80210f:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  802114:	0f 45 c3             	cmovne %ebx,%eax
  802117:	8b 55 14             	mov    0x14(%ebp),%edx
  80211a:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80211e:	89 44 24 08          	mov    %eax,0x8(%esp)
  802122:	89 74 24 04          	mov    %esi,0x4(%esp)
  802126:	89 3c 24             	mov    %edi,(%esp)
  802129:	e8 2e ee ff ff       	call   800f5c <sys_ipc_try_send>
  80212e:	85 c0                	test   %eax,%eax
  802130:	75 b6                	jne    8020e8 <ipc_send+0x14>
		if (err_code != -E_IPC_NOT_RECV) {
			panic("ipc_send:%e", err_code);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  802140:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  802145:	39 c8                	cmp    %ecx,%eax
  802147:	74 17                	je     802160 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80215c:	75 14                	jne    802172 <ipc_find_env+0x38>
  80215e:	eb 05                	jmp    802165 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802165:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802168:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80216d:	8b 40 40             	mov    0x40(%eax),%eax
  802170:	eb 0e                	jmp    802180 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80217a:	75 d2                	jne    80214e <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80217c:	66 b8 00 00          	mov    $0x0,%ax
}
  802180:	5d                   	pop    %ebp
  802181:	c3                   	ret    
